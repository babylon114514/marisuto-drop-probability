...
new Chara(43, "SIY", 45),
new Chara(44, "GO", 46),
new Chara(45, "レッドセミ兄貴", 145),
new Chara(46, "ブルーセミ兄貴", 146),
new Chara(47, "セミ兄貴", 147),
new Chara(48, "光に満ちたセミ兄貴", 148),
new Chara(49, "闇に堕ちたセミ兄貴", 149),
new Chara(50, "メガカイロSIK", 150),
new Chara(51, "サマーMSTA姉貴", 169),
new Chara(52, "バレンタインRIM", 173),
new Chara(53, "バレンタインUDK", 174),
new Chara(54, "バレンタインALC", 175),
new Chara(55, "YKR姉貴", 205),
new Chara(56, "邪神GO", 206),
new Chara(57, "SNE姉貴", 117),
new Chara(58, "SWK様", 118),
new Chara(59, "風神KNK", 119),
new Chara(60, "神々の頂点SWK", 120),
new Chara(61, "イワナを焼くUDK", 111),
new Chara(62, "サマーRIM姉貴", 170),
new Chara(63, "サマーUDK姉貴", 171),
new Chara(64, "サマーALC姉貴", 172),
new Chara(65, "サマーHZR姉貴", 176),
new Chara(66, "サマーピンキー姉貴", 182),
...
new Chara(90, "たまドラ田中", 202),
new Chara(91, "MMJ姉貴", 168),
...
new Chara(112, "全てを狩る先輩", 151),
new Chara(113, "花嫁と化した先輩", 177),
new Chara(114, "嫁TIT", 178),
new Chara(115, "花嫁ピンキー", 179),
new Chara(116, "ノンケスレイヤー", 180),
new Chara(117, "BSTIT", 181),
new Chara(118, "ビリー兄貴", 152),
new Chara(119, "木吉カズヤ", 153),
new Chara(120, "井上カブレラ", 154),
new Chara(121, "いかりやビオランテ", 155),
new Chara(122, "TDNコスギ", 156),
new Chara(123, "赤さん", 157),
new Chara(124, "VAN様", 158),
new Chara(125, "カグラ=ウヅキ", 113),
new Chara(126, "ESKちゃん", 183),
new Chara(127, "YW姉貴", 184),
new Chara(128, "ITUASK", 185),
new Chara(129, "バンホーテンダー", 114),
new Chara(130, "MZ姉貴", 186),
new Chara(131, "AZS姉貴", 187),
new Chara(132, "RI姉貴", 188),
new Chara(133, "朗読兄貴", 189),
...
new Chara(162, "AY姉貴", 196),
new Chara(163, "TNS姉貴", 197),
new Chara(164, "HTT姉貴", 198),
new Chara(165, "MDCNちゃん", 199),
new Chara(166, "RNNSK兄貴", 200),
...
new Chara(177, "須藤さん", 159),
new Chara(178, "池田茂美", 160),
new Chara(179, "妖精王チチラルー", 161),
new Chara(180, "ALISON兄貴", 194),
new Chara(181, "ZUN", 195),
new Chara(182, "チャリオット平野", 190),
new Chara(183, "剣聖おじさん", 191),
new Chara(184, "破面KBTIT", 192),
new Chara(185, "AKMRくん", 193),
...
new Chara(197, "完全勝利した淫夢くんUC", 203),
new Chara(198, "風来人RU", 162),
new Chara(199, "ESKドラゴン", 163),
new Chara(200, "ジャボテンダーALC", 164),
new Chara(201, "多脚ひで", 165),
new Chara(202, "ピン鬼", 166),
new Chara(203, "ダークドレアム先輩", 167),
new Chara(204, "釣リスマスおばさん", 204),
...
new Difficulty(123, "セミ兄貴の森(EAS)", false, [new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[50], 0.31), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0)]),
new Difficulty(124, "セミ兄貴の森(ADV)", false, [new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[50], 0.61), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0)]),
new Difficulty(125, "セミ兄貴の森(EXH)", false, [new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[50], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0)]),
new Difficulty(126, "セミ兄貴の森(LEG)", false, [new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[50], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[109], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[112], 1.0), new Enemy(Chara.all[50], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[109], 1.0)]),
new Difficulty(127, "妖精の森(EAS)", false, [new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[47], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[46], 0.0), new Enemy(Chara.all[118], 1.0), new Enemy(Chara.all[119], 1.0), new Enemy(Chara.all[121], 0.0), new Enemy(Chara.all[122], 0.0), new Enemy(Chara.all[120], 0.0)]),
new Difficulty(128, "妖精の森(ADV)", false, [new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[47], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[46], 0.0), new Enemy(Chara.all[5], 1.0), new Enemy(Chara.all[49], 0.0), new Enemy(Chara.all[118], 1.0), new Enemy(Chara.all[119], 0.51), new Enemy(Chara.all[121], 1.0), new Enemy(Chara.all[122], 1.0), new Enemy(Chara.all[120], 1.0)]),
new Difficulty(129, "妖精の森(EXH)", false, [new Enemy(Chara.all[118], 1.0), new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[7], 0.0), new Enemy(Chara.all[47], 0.0), new Enemy(Chara.all[119], 1.0), new Enemy(Chara.all[5], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[118], 0.0), new Enemy(Chara.all[46], 0.0), new Enemy(Chara.all[120], 1.0), new Enemy(Chara.all[121], 0.0), new Enemy(Chara.all[123], 1.0), new Enemy(Chara.all[118], 1.0), new Enemy(Chara.all[45], 0.0), new Enemy(Chara.all[122], 1.0), new Enemy(Chara.all[49], 0.0), new Enemy(Chara.all[5], 1.0), new Enemy(Chara.all[7], 1.0), new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[118], 1.0), new Enemy(Chara.all[120], 1.0), new Enemy(Chara.all[121], 1.0), new Enemy(Chara.all[124], 1.0), new Enemy(Chara.all[123], 1.0)]),
new Difficulty(130, "妖精の森(LEG)", false, [new Enemy(Chara.all[118], 1.0), new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[157], 0.0), new Enemy(Chara.all[7], 0.0), new Enemy(Chara.all[47], 0.0), new Enemy(Chara.all[119], 1.0), new Enemy(Chara.all[5], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[118], 0.0), new Enemy(Chara.all[46], 0.0), new Enemy(Chara.all[177], 1.0), new Enemy(Chara.all[5], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[122], 0.0), new Enemy(Chara.all[46], 0.0), new Enemy(Chara.all[120], 1.0), new Enemy(Chara.all[121], 0.0), new Enemy(Chara.all[123], 1.0), new Enemy(Chara.all[118], 1.0), new Enemy(Chara.all[45], 0.0), new Enemy(Chara.all[122], 1.0), new Enemy(Chara.all[49], 0.0), new Enemy(Chara.all[5], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[178], 1.0), new Enemy(Chara.all[119], 0.0), new Enemy(Chara.all[118], 1.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[179], 1.0), new Enemy(Chara.all[120], 1.0), new Enemy(Chara.all[118], 1.0), new Enemy(Chara.all[124], 1.0)]),
new Difficulty(131, "BBの森(EAS)", false, [new Enemy(Chara.all[198], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[199], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[200], 0.31), new Enemy(Chara.all[46], 0.0)]),
new Difficulty(132, "BBの森(ADV)", false, [new Enemy(Chara.all[157], 0.31), new Enemy(Chara.all[47], 0.0), new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[201], 0.31), new Enemy(Chara.all[49], 0.0), new Enemy(Chara.all[200], 1.0), new Enemy(Chara.all[199], 1.0), new Enemy(Chara.all[47], 0.0), new Enemy(Chara.all[104], 0.0), new Enemy(Chara.all[153], 0.0), new Enemy(Chara.all[28], 0.0), new Enemy(Chara.all[202], 0.31), new Enemy(Chara.all[48], 0.0), new Enemy(Chara.all[118], 0.0), new Enemy(Chara.all[120], 0.0), new Enemy(Chara.all[122], 0.0), new Enemy(Chara.all[203], 0.31), new Enemy(Chara.all[45], 0.0), new Enemy(Chara.all[4], 0.0), new Enemy(Chara.all[123], 0.0), new Enemy(Chara.all[198], 1.0)])
];
