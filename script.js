...
new Chara(43, "SIY", 43),
new Chara(44, "GO", 44),
new Chara(45, "レッドセミ兄貴", 132),
new Chara(46, "ブルーセミ兄貴", 133),
new Chara(47, "セミ兄貴", 134),
new Chara(48, "光に満ちたセミ兄貴", 135),
new Chara(49, "闇に堕ちたセミ兄貴", 136),
new Chara(50, "メガカイロSIK", 137),
new Chara(51, "サマーMSTA姉貴", 150),
new Chara(52, "バレンタインRIM", 154),
new Chara(53, "バレンタインUDK", 155),
new Chara(54, "バレンタインALC", 156),
new Chara(55, "YKR姉貴", 184),
new Chara(56, "邪神GO", 185),
new Chara(57, "SNE姉貴", 104),
new Chara(58, "SWK様", 105),
new Chara(59, "風神KNK", 106),
new Chara(60, "神々の頂点SWK", 107),
new Chara(61, "イワナを焼くUDK", 98),
new Chara(62, "サマーRIM姉貴", 151),
new Chara(63, "サマーUDK姉貴", 152),
new Chara(64, "サマーALC姉貴", 153),
new Chara(65, "サマーHZR姉貴", 157),
new Chara(66, "サマーピンキー姉貴", 163),
...
new Chara(76, "YMMちゃん", 111),
new Chara(77, "PLSY姉貴", 112),
new Chara(78, "YUG姉貴", 113),
new Chara(79, "STR姉貴", 114),
new Chara(80, "ORN姉貴", 115),
new Chara(81, "KISちゃん", 116),
new Chara(82, "太陽神NDK", 117),
...
new Chara(90, "たまドラ田中", 183),
new Chara(91, "MMJ姉貴", 149),
new Chara(92, "いなり男", 61),
new Chara(93, "AKG", 62),
new Chara(94, "関西クレーマー", 63),
new Chara(95, "現場監督", 64),
new Chara(96, "変態郵便屋", 91),
new Chara(97, "インパルスITKR", 92),
new Chara(98, "小森", 93),
new Chara(99, "ホリ・トオル", 94),
new Chara(100, "ラザマリナ", 99),
...
new Chara(109, "植木鉢くん", 90),
new Chara(110, "PSR姉貴", 108),
new Chara(111, "化物と化したPSR姉貴", 109),
new Chara(112, "全てを狩る先輩", 138),
new Chara(113, "花嫁と化した先輩", 158),
new Chara(114, "嫁TIT", 159),
new Chara(115, "花嫁ピンキー", 160),
new Chara(116, "ノンケスレイヤー", 161),
new Chara(117, "BSTIT", 162),
new Chara(118, "ビリー兄貴", 139),
new Chara(119, "木吉カズヤ", 140),
new Chara(120, "井上カブレラ", 141),
new Chara(121, "いかりやビオランテ", 142),
new Chara(122, "TDNコスギ", 143),
new Chara(123, "赤さん", 144),
new Chara(124, "VAN様", 145),
new Chara(125, "カグラ=ウヅキ", 100),
new Chara(126, "ESKちゃん", 164),
new Chara(127, "YW姉貴", 165),
new Chara(128, "ITUASK", 166),
new Chara(129, "バンホーテンダー", 101),
new Chara(130, "MZ姉貴", 167),
new Chara(131, "AZS姉貴", 168),
new Chara(132, "RI姉貴", 169),
new Chara(133, "朗読兄貴", 170),
new Chara(134, "デビルひで", 119),
new Chara(135, "ナイトメアビリー兄貴", 120),
new Chara(136, "ベルモンド先輩", 121),
new Chara(137, "ナイトメアMIRN姉貴", 122),
new Chara(138, "ナイトメアKSDB姉貴", 123),
new Chara(139, "ナイトメアPCLY姉貴", 124),
new Chara(140, "ナイトメアSKY姉貴", 125),
new Chara(141, "ナイトメアRMLA姉貴", 126),
new Chara(142, "ナイトメアFLNちゃん", 127),
new Chara(143, "スカーレット内閣", 128),
new Chara(144, "黄金のSWK様", 110),
new Chara(145, "ZNM姉貴", 118),
...
new Chara(155, "中盤に出てくる鳥", 182),
new Chara(156, "ダークロウ先輩", 102),
new Chara(157, "交通整理DIちゃん", 89),
new Chara(158, "世界のトオノ", 95),
new Chara(159, "ビューティ先輩", 96),
new Chara(160, "ミミックおばさん", 129),
new Chara(161, "メカNDK", 103),
new Chara(162, "AY姉貴", 177),
new Chara(163, "TNS姉貴", 178),
new Chara(164, "HTT姉貴", 179),
new Chara(165, "MDCNちゃん", 180),
new Chara(166, "RNNSK兄貴", 181),
new Chara(167, "逝かせ隊", 82),
new Chara(168, "ポイテーロ", 83),
new Chara(169, "ウルトラマンタクヤ", 97),
new Chara(170, "LNK", 84),
new Chara(171, "キモヲタ平野", 87),
new Chara(172, "TNKL", 85),
new Chara(173, "うさぎ", 86),
new Chara(174, "タナトスひで", 88),
new Chara(175, "Y.AOI", 130),
new Chara(176, "メガMTGRS先輩", 131),
new Chara(177, "須藤さん", 146),
new Chara(178, "池田茂美", 147),
new Chara(179, "妖精王チチラルー", 148),
new Chara(180, "ALISON兄貴", 175),
new Chara(181, "ZUN", 176),
new Chara(182, "チャリオット平野", 171),
new Chara(183, "剣聖おじさん", 172),
new Chara(184, "破面KBTIT", 173),
new Chara(185, "AKMRくん", 174)
];
...
new Difficulty(67, "少年市場(EAS)", false, [new Enemy(Chara.all[147], 1.0), new Enemy(Chara.all[27], 1.0), new Enemy(Chara.all[29], 1.0), new Enemy(Chara.all[28], 1.0), new Enemy(Chara.all[102], 0.51), new Enemy(Chara.all[37], 0.51), new Enemy(Chara.all[92], 1.0), new Enemy(Chara.all[104], 1.0), new Enemy(Chara.all[148], 0.51), new Enemy(Chara.all[11], 1.0), new Enemy(Chara.all[44], 1.0), new Enemy(Chara.all[43], 1.0), new Enemy(Chara.all[94], 0.31), new Enemy(Chara.all[93], 1.0), new Enemy(Chara.all[36], 1.0), new Enemy(Chara.all[101], 1.0), new Enemy(Chara.all[170], 0.11), new Enemy(Chara.all[27], 1.0), new Enemy(Chara.all[29], 1.0), new Enemy(Chara.all[103], 1.0), new Enemy(Chara.all[171], 0.11), new Enemy(Chara.all[39], 0.0), new Enemy(Chara.all[23], 0.0), new Enemy(Chara.all[9], 0.0), new Enemy(Chara.all[18], 0.0)]),
new Difficulty(68, "少年市場(ADV)", false, [new Enemy(Chara.all[103], 1.0), new Enemy(Chara.all[12], 1.0), new Enemy(Chara.all[7], 1.0), new Enemy(Chara.all[158], 1.0), new Enemy(Chara.all[27], 1.0), new Enemy(Chara.all[68], 1.0), new Enemy(Chara.all[41], 1.0), new Enemy(Chara.all[30], 1.0), new Enemy(Chara.all[167], 1.0), new Enemy(Chara.all[67], 1.0), new Enemy(Chara.all[172], 0.51), new Enemy(Chara.all[37], 1.0), new Enemy(Chara.all[92], 1.0), new Enemy(Chara.all[102], 1.0), new Enemy(Chara.all[95], 1.0), new Enemy(Chara.all[151], 0.51), new Enemy(Chara.all[25], 1.0), new Enemy(Chara.all[71], 1.0), new Enemy(Chara.all[67], 1.0), new Enemy(Chara.all[40], 1.0), new Enemy(Chara.all[147], 1.0), new Enemy(Chara.all[148], 1.0), new Enemy(Chara.all[149], 0.51), new Enemy(Chara.all[20], 1.0), new Enemy(Chara.all[11], 1.0), new Enemy(Chara.all[170], 0.51), new Enemy(Chara.all[17], 1.0), new Enemy(Chara.all[28], 1.0), new Enemy(Chara.all[152], 1.0), new Enemy(Chara.all[4], 1.0), new Enemy(Chara.all[158], 0.51), new Enemy(Chara.all[85], 1.0), new Enemy(Chara.all[7], 1.0), new Enemy(Chara.all[21], 1.0), new Enemy(Chara.all[171], 0.51), new Enemy(Chara.all[88], 0.31), new Enemy(Chara.all[21], 0.31), new Enemy(Chara.all[39], 0.51)]),
new Difficulty(69, "少年市場(EXH)", false, [new Enemy(Chara.all[147], 1.0), new Enemy(Chara.all[27], 1.0), new Enemy(Chara.all[28], 1.0), new Enemy(Chara.all[29], 1.0), new Enemy(Chara.all[7], 1.0), new Enemy(Chara.all[68], 1.0), new Enemy(Chara.all[87], 1.0), new Enemy(Chara.all[30], 1.0), new Enemy(Chara.all[167], 1.0), new Enemy(Chara.all[67], 1.0), new Enemy(Chara.all[103], 1.0), new Enemy(Chara.all[157], 1.0), new Enemy(Chara.all[93], 1.0), new Enemy(Chara.all[70], 1.0), new Enemy(Chara.all[87], 1.0), new Enemy(Chara.all[172], 1.0), new Enemy(Chara.all[39], 1.0), new Enemy(Chara.all[21], 1.0), new Enemy(Chara.all[94], 1.0), new Enemy(Chara.all[173], 0.51), new Enemy(Chara.all[157], 1.0), new Enemy(Chara.all[5], 1.0), new Enemy(Chara.all[6], 1.0), new Enemy(Chara.all[74], 1.0), new Enemy(Chara.all[148], 1.0), new Enemy(Chara.all[102], 1.0), new Enemy(Chara.all[149], 1.0), new Enemy(Chara.all[147], 1.0), new Enemy(Chara.all[10], 1.0), new Enemy(Chara.all[170], 0.31), new Enemy(Chara.all[153], 1.0), new Enemy(Chara.all[28], 1.0), new Enemy(Chara.all[152], 1.0), new Enemy(Chara.all[27], 0.51), new Enemy(Chara.all[174], 0.31), new Enemy(Chara.all[146], 0.31), new Enemy(Chara.all[171], 0.31), new Enemy(Chara.all[88], 0.51)]),
new Difficulty(70, "守矢神社(EAS)", true, [new Enemy(Chara.all[5], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[4], 0.0), new Enemy(Chara.all[10], 1.0), new Enemy(Chara.all[11], 1.0), new Enemy(Chara.all[8], 1.0), new Enemy(Chara.all[9], 1.0), new Enemy(Chara.all[12], 1.0), new Enemy(Chara.all[15], 1.0), new Enemy(Chara.all[14], 1.0), new Enemy(Chara.all[13], 0.51), new Enemy(Chara.all[57], 1.0), new Enemy(Chara.all[58], 0.31), new Enemy(Chara.all[39], 0.31), new Enemy(Chara.all[37], 0.31)]),
new Difficulty(71, "守矢神社(ADV)", true, [new Enemy(Chara.all[5], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[4], 0.0), new Enemy(Chara.all[10], 1.0), new Enemy(Chara.all[11], 1.0), new Enemy(Chara.all[8], 1.0), new Enemy(Chara.all[9], 1.0), new Enemy(Chara.all[12], 1.0), new Enemy(Chara.all[15], 1.0), new Enemy(Chara.all[14], 1.0), new Enemy(Chara.all[13], 0.81), new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[27], 1.0), new Enemy(Chara.all[31], 1.0), new Enemy(Chara.all[43], 1.0), new Enemy(Chara.all[25], 1.0), new Enemy(Chara.all[30], 1.0), new Enemy(Chara.all[59], 0.31), new Enemy(Chara.all[58], 1.0), new Enemy(Chara.all[57], 1.0), new Enemy(Chara.all[39], 0.51)]),
new Difficulty(72, "守矢神社(EXH)", true, [new Enemy(Chara.all[5], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[4], 0.0), new Enemy(Chara.all[10], 1.0), new Enemy(Chara.all[11], 1.0), new Enemy(Chara.all[8], 1.0), new Enemy(Chara.all[9], 1.0), new Enemy(Chara.all[12], 1.0), new Enemy(Chara.all[15], 1.0), new Enemy(Chara.all[14], 1.0), new Enemy(Chara.all[13], 0.81), new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[27], 1.0), new Enemy(Chara.all[19], 1.0), new Enemy(Chara.all[43], 1.0), new Enemy(Chara.all[20], 1.0), new Enemy(Chara.all[30], 1.0), new Enemy(Chara.all[29], 1.0), new Enemy(Chara.all[42], 1.0), new Enemy(Chara.all[28], 1.0), new Enemy(Chara.all[23], 1.0), new Enemy(Chara.all[38], 1.0), new Enemy(Chara.all[41], 0.31), new Enemy(Chara.all[37], 0.51), new Enemy(Chara.all[22], 0.51), new Enemy(Chara.all[25], 1.0), new Enemy(Chara.all[59], 1.0), new Enemy(Chara.all[58], 1.0), new Enemy(Chara.all[57], 1.0), new Enemy(Chara.all[39], 1.0)]),
new Difficulty(73, "守矢神社(LEG)", true, [new Enemy(Chara.all[5], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[4], 0.0), new Enemy(Chara.all[10], 0.0), new Enemy(Chara.all[11], 0.0), new Enemy(Chara.all[8], 0.0), new Enemy(Chara.all[9], 0.0), new Enemy(Chara.all[12], 0.0), new Enemy(Chara.all[15], 0.0), new Enemy(Chara.all[14], 0.0), new Enemy(Chara.all[13], 0.51), new Enemy(Chara.all[18], 0.0), new Enemy(Chara.all[27], 0.0), new Enemy(Chara.all[19], 0.0), new Enemy(Chara.all[43], 1.0), new Enemy(Chara.all[20], 0.0), new Enemy(Chara.all[30], 0.51), new Enemy(Chara.all[29], 0.0), new Enemy(Chara.all[42], 0.51), new Enemy(Chara.all[28], 0.51), new Enemy(Chara.all[23], 0.0), new Enemy(Chara.all[38], 0.51), new Enemy(Chara.all[41], 0.31), new Enemy(Chara.all[37], 0.51), new Enemy(Chara.all[22], 0.51), new Enemy(Chara.all[25], 0.51), new Enemy(Chara.all[29], 0.51), new Enemy(Chara.all[42], 1.0), new Enemy(Chara.all[28], 0.51), new Enemy(Chara.all[37], 0.51), new Enemy(Chara.all[22], 0.0), new Enemy(Chara.all[25], 0.51), new Enemy(Chara.all[59], 1.0), new Enemy(Chara.all[60], 1.0), new Enemy(Chara.all[57], 1.0)]),
new Difficulty(74, "真夏の水着ユニット乱入フェスティバル(サマーMSTA姉貴戦)", true, [new Enemy(Chara.all[51], 1.0), new Enemy(Chara.all[12], 0.51), new Enemy(Chara.all[5], 0.51), new Enemy(Chara.all[10], 0.51), new Enemy(Chara.all[4], 0.51)]),
new Difficulty(75, "真夏の水着ユニット乱入フェスティバル(サマーRIM姉貴戦)", true, [new Enemy(Chara.all[62], 1.0), new Enemy(Chara.all[53], 0.51), new Enemy(Chara.all[54], 0.51), new Enemy(Chara.all[5], 0.51), new Enemy(Chara.all[6], 0.51)]),
new Difficulty(76, "真夏の水着ユニット乱入フェスティバル(サマーUDK姉貴戦)", true, [new Enemy(Chara.all[63], 1.0), new Enemy(Chara.all[52], 0.51), new Enemy(Chara.all[54], 0.51), new Enemy(Chara.all[17], 0.51), new Enemy(Chara.all[7], 0.51)]),
new Difficulty(77, "真夏の水着ユニット乱入フェスティバル(サマーALC姉貴戦)", true, [new Enemy(Chara.all[64], 1.0), new Enemy(Chara.all[52], 0.51), new Enemy(Chara.all[53], 0.51), new Enemy(Chara.all[12], 0.51), new Enemy(Chara.all[11], 0.51)]),
new Difficulty(78, "真夏の水着ユニット乱入フェスティバル(サマーHZR姉貴戦)", true, [new Enemy(Chara.all[65], 1.0), new Enemy(Chara.all[62], 0.51), new Enemy(Chara.all[63], 0.51), new Enemy(Chara.all[64], 0.51)]),
new Difficulty(79, "真夏の水着ユニット乱入フェスティバル(サマーピンキー姉貴戦)", true, [new Enemy(Chara.all[66], 1.0), new Enemy(Chara.all[51], 0.51), new Enemy(Chara.all[51], 0.51), new Enemy(Chara.all[51], 0.51)]),
new Difficulty(80, "地霊殿(EAS)", true, [new Enemy(Chara.all[5], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[76], 1.0), new Enemy(Chara.all[9], 0.51), new Enemy(Chara.all[7], 0.51), new Enemy(Chara.all[77], 0.31), new Enemy(Chara.all[14], 0.51), new Enemy(Chara.all[12], 0.51), new Enemy(Chara.all[78], 0.11), new Enemy(Chara.all[9], 0.0), new Enemy(Chara.all[4], 0.51), new Enemy(Chara.all[79], 0.06), new Enemy(Chara.all[8], 0.31), new Enemy(Chara.all[17], 0.31), new Enemy(Chara.all[7], 0.31)]),
new Difficulty(81, "地霊殿(ADV)", true, [new Enemy(Chara.all[5], 0.11), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[13], 0.0), new Enemy(Chara.all[76], 1.0), new Enemy(Chara.all[9], 0.0), new Enemy(Chara.all[4], 0.51), new Enemy(Chara.all[3], 0.51), new Enemy(Chara.all[32], 0.51), new Enemy(Chara.all[33], 0.0), new Enemy(Chara.all[34], 0.0), new Enemy(Chara.all[77], 0.51), new Enemy(Chara.all[14], 0.0), new Enemy(Chara.all[18], 0.21), new Enemy(Chara.all[26], 0.0), new Enemy(Chara.all[21], 0.51), new Enemy(Chara.all[28], 0.0), new Enemy(Chara.all[39], 0.0), new Enemy(Chara.all[78], 0.31), new Enemy(Chara.all[35], 0.51), new Enemy(Chara.all[41], 0.51), new Enemy(Chara.all[17], 0.51), new Enemy(Chara.all[79], 0.21), new Enemy(Chara.all[8], 0.31), new Enemy(Chara.all[80], 0.31), new Enemy(Chara.all[7], 0.31), new Enemy(Chara.all[36], 0.31)]),
new Difficulty(82, "地霊殿(EXH)", true, [new Enemy(Chara.all[5], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[14], 0.0), new Enemy(Chara.all[15], 0.31), new Enemy(Chara.all[68], 0.0), new Enemy(Chara.all[29], 0.0), new Enemy(Chara.all[28], 0.0), new Enemy(Chara.all[30], 0.0), new Enemy(Chara.all[76], 1.0), new Enemy(Chara.all[35], 0.0), new Enemy(Chara.all[72], 0.0), new Enemy(Chara.all[12], 0.0), new Enemy(Chara.all[32], 0.51), new Enemy(Chara.all[33], 0.0), new Enemy(Chara.all[34], 0.0), new Enemy(Chara.all[42], 0.0), new Enemy(Chara.all[77], 1.0), new Enemy(Chara.all[14], 0.0), new Enemy(Chara.all[18], 0.0), new Enemy(Chara.all[67], 1.0), new Enemy(Chara.all[21], 1.0), new Enemy(Chara.all[28], 0.0), new Enemy(Chara.all[39], 0.0), new Enemy(Chara.all[70], 0.31), new Enemy(Chara.all[78], 1.0), new Enemy(Chara.all[35], 0.51), new Enemy(Chara.all[41], 0.51), new Enemy(Chara.all[17], 0.51), new Enemy(Chara.all[44], 1.0), new Enemy(Chara.all[43], 0.51), new Enemy(Chara.all[11], 0.51), new Enemy(Chara.all[22], 0.51), new Enemy(Chara.all[76], 1.0), new Enemy(Chara.all[77], 0.51), new Enemy(Chara.all[78], 0.51), new Enemy(Chara.all[80], 0.51), new Enemy(Chara.all[79], 1.0), new Enemy(Chara.all[8], 0.31), new Enemy(Chara.all[80], 1.0), new Enemy(Chara.all[81], 0.31), new Enemy(Chara.all[36], 0.31)]),
new Difficulty(83, "地霊殿(LEG)", true, [new Enemy(Chara.all[5], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[14], 0.0), new Enemy(Chara.all[15], 0.31), new Enemy(Chara.all[69], 0.31), new Enemy(Chara.all[68], 0.0), new Enemy(Chara.all[29], 0.0), new Enemy(Chara.all[28], 0.0), new Enemy(Chara.all[30], 0.0), new Enemy(Chara.all[76], 1.0), new Enemy(Chara.all[35], 0.0), new Enemy(Chara.all[72], 0.0), new Enemy(Chara.all[72], 0.0), new Enemy(Chara.all[12], 0.0), new Enemy(Chara.all[32], 0.51), new Enemy(Chara.all[33], 0.0), new Enemy(Chara.all[34], 0.0), new Enemy(Chara.all[35], 0.0), new Enemy(Chara.all[42], 0.0), new Enemy(Chara.all[77], 1.0), new Enemy(Chara.all[14], 0.0), new Enemy(Chara.all[18], 0.0), new Enemy(Chara.all[69], 1.0), new Enemy(Chara.all[67], 1.0), new Enemy(Chara.all[21], 1.0), new Enemy(Chara.all[28], 0.0), new Enemy(Chara.all[39], 0.0), new Enemy(Chara.all[70], 0.31), new Enemy(Chara.all[78], 1.0), new Enemy(Chara.all[35], 0.51), new Enemy(Chara.all[41], 0.51), new Enemy(Chara.all[17], 0.51), new Enemy(Chara.all[44], 1.0), new Enemy(Chara.all[43], 0.51), new Enemy(Chara.all[11], 0.51), new Enemy(Chara.all[22], 0.51), new Enemy(Chara.all[76], 1.0), new Enemy(Chara.all[77], 0.51), new Enemy(Chara.all[78], 0.51), new Enemy(Chara.all[80], 0.51), new Enemy(Chara.all[79], 1.0), new Enemy(Chara.all[8], 0.31), new Enemy(Chara.all[80], 1.0), new Enemy(Chara.all[81], 0.31), new Enemy(Chara.all[36], 0.31), new Enemy(Chara.all[82], 1.0), new Enemy(Chara.all[81], 0.0), new Enemy(Chara.all[79], 0.0)]),
new Difficulty(84, "スマブラ発売記念乱入クエスト(変態郵便屋戦)", true, [new Enemy(Chara.all[96], 0.71), new Enemy(Chara.all[52], 0.51), new Enemy(Chara.all[12], 0.51), new Enemy(Chara.all[28], 0.51), new Enemy(Chara.all[84], 0.51)]),
new Difficulty(85, "スマブラ発売記念乱入クエスト(インパルスITKR戦)", true, [new Enemy(Chara.all[97], 0.31), new Enemy(Chara.all[53], 0.51), new Enemy(Chara.all[35], 0.0), new Enemy(Chara.all[41], 0.51), new Enemy(Chara.all[12], 0.51)]),
new Difficulty(86, "スマブラ発売記念乱入クエスト(小森戦)", true, [new Enemy(Chara.all[98], 1.0), new Enemy(Chara.all[54], 0.51), new Enemy(Chara.all[67], 0.0), new Enemy(Chara.all[4], 0.0), new Enemy(Chara.all[6], 0.0)]),
new Difficulty(87, "スマブラ発売記念乱入クエスト(ホリ・トオル戦)", true, [new Enemy(Chara.all[99], 1.0), new Enemy(Chara.all[65], 1.0), new Enemy(Chara.all[89], 0.0)]),
new Difficulty(88, "まりりんぴっく　ちびっこの部(EAS)", true, [new Enemy(Chara.all[5], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[52], 1.0), new Enemy(Chara.all[62], 0.51), new Enemy(Chara.all[102], 0.51), new Enemy(Chara.all[7], 0.51), new Enemy(Chara.all[126], 0.11), new Enemy(Chara.all[8], 0.31), new Enemy(Chara.all[17], 0.31)]),
new Difficulty(89, "まりりんぴっく　ちびっこの部(ADV)", true, [new Enemy(Chara.all[5], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[52], 1.0), new Enemy(Chara.all[84], 0.51), new Enemy(Chara.all[93], 0.51), new Enemy(Chara.all[95], 0.51), new Enemy(Chara.all[20], 0.51), new Enemy(Chara.all[57], 0.51), new Enemy(Chara.all[58], 0.51), new Enemy(Chara.all[62], 1.0), new Enemy(Chara.all[102], 1.0), new Enemy(Chara.all[7], 0.51), new Enemy(Chara.all[126], 0.31), new Enemy(Chara.all[28], 0.31), new Enemy(Chara.all[17], 0.31), new Enemy(Chara.all[109], 0.31)]),
new Difficulty(90, "まりりんぴっく　ちびっこの部(EXH)", true, [new Enemy(Chara.all[5], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[52], 1.0), new Enemy(Chara.all[84], 0.31), new Enemy(Chara.all[62], 0.51), new Enemy(Chara.all[102], 0.51), new Enemy(Chara.all[7], 0.51), new Enemy(Chara.all[67], 0.31), new Enemy(Chara.all[104], 0.51), new Enemy(Chara.all[38], 0.51), new Enemy(Chara.all[17], 0.51), new Enemy(Chara.all[57], 0.51), new Enemy(Chara.all[58], 0.51), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[126], 1.0), new Enemy(Chara.all[88], 0.31), new Enemy(Chara.all[123], 0.31), new Enemy(Chara.all[89], 0.31)]),
new Difficulty(91, "まりりんぴっく　応援団の部(EAS)", true, [new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[4], 0.0), new Enemy(Chara.all[53], 1.0), new Enemy(Chara.all[63], 0.51), new Enemy(Chara.all[101], 0.51), new Enemy(Chara.all[10], 0.51), new Enemy(Chara.all[127], 0.11), new Enemy(Chara.all[9], 0.31), new Enemy(Chara.all[51], 0.31)]),
new Difficulty(92, "まりりんぴっく　応援団の部(ADV)", true, [new Enemy(Chara.all[11], 0.0), new Enemy(Chara.all[12], 0.0), new Enemy(Chara.all[53], 1.0), new Enemy(Chara.all[25], 0.51), new Enemy(Chara.all[36], 0.51), new Enemy(Chara.all[22], 0.51), new Enemy(Chara.all[19], 0.51), new Enemy(Chara.all[59], 0.51), new Enemy(Chara.all[63], 1.0), new Enemy(Chara.all[101], 1.0), new Enemy(Chara.all[7], 0.51), new Enemy(Chara.all[127], 0.31), new Enemy(Chara.all[105], 0.31), new Enemy(Chara.all[8], 0.31), new Enemy(Chara.all[7], 0.31)]),
new Difficulty(93, "まりりんぴっく　応援団の部(EXH)", true, [new Enemy(Chara.all[67], 0.0), new Enemy(Chara.all[12], 0.0), new Enemy(Chara.all[53], 1.0), new Enemy(Chara.all[11], 0.31), new Enemy(Chara.all[109], 0.31), new Enemy(Chara.all[63], 0.51), new Enemy(Chara.all[101], 0.51), new Enemy(Chara.all[7], 0.51), new Enemy(Chara.all[67], 0.31), new Enemy(Chara.all[35], 0.51), new Enemy(Chara.all[41], 0.51), new Enemy(Chara.all[72], 0.51), new Enemy(Chara.all[59], 0.51), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[127], 1.0), new Enemy(Chara.all[18], 0.31), new Enemy(Chara.all[20], 0.31), new Enemy(Chara.all[21], 0.31)]),
new Difficulty(94, "まりりんぴっく　父兄の部(EAS)", true, [new Enemy(Chara.all[9], 0.0), new Enemy(Chara.all[14], 0.0), new Enemy(Chara.all[54], 1.0), new Enemy(Chara.all[64], 0.51), new Enemy(Chara.all[103], 0.51), new Enemy(Chara.all[15], 0.51), new Enemy(Chara.all[128], 0.11), new Enemy(Chara.all[13], 0.31), new Enemy(Chara.all[16], 0.31)]),
new Difficulty(95, "まりりんぴっく　父兄の部(ADV)", true, [new Enemy(Chara.all[11], 0.0), new Enemy(Chara.all[12], 0.0), new Enemy(Chara.all[54], 1.0), new Enemy(Chara.all[25], 0.51), new Enemy(Chara.all[85], 0.51), new Enemy(Chara.all[74], 0.51), new Enemy(Chara.all[18], 0.51), new Enemy(Chara.all[60], 0.51), new Enemy(Chara.all[64], 1.0), new Enemy(Chara.all[103], 1.0), new Enemy(Chara.all[7], 0.51), new Enemy(Chara.all[128], 0.31), new Enemy(Chara.all[51], 0.31), new Enemy(Chara.all[17], 0.31), new Enemy(Chara.all[7], 0.31)]),
new Difficulty(96, "まりりんぴっく　父兄の部(EXH)", true, [new Enemy(Chara.all[15], 0.0), new Enemy(Chara.all[16], 0.0), new Enemy(Chara.all[54], 1.0), new Enemy(Chara.all[10], 0.0), new Enemy(Chara.all[13], 0.0), new Enemy(Chara.all[64], 0.51), new Enemy(Chara.all[103], 0.51), new Enemy(Chara.all[12], 0.51), new Enemy(Chara.all[68], 0.31), new Enemy(Chara.all[88], 0.51), new Enemy(Chara.all[26], 0.51), new Enemy(Chara.all[39], 0.51), new Enemy(Chara.all[60], 0.51), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[128], 1.0), new Enemy(Chara.all[35], 0.31), new Enemy(Chara.all[32], 0.31), new Enemy(Chara.all[33], 0.31), new Enemy(Chara.all[34], 0.31)]),
new Difficulty(97, "体育の日乱入クエスト(野獣&遠野戦)", true, [new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[19], 0.0), new Enemy(Chara.all[128], 0.0), new Enemy(Chara.all[127], 0.0), new Enemy(Chara.all[126], 0.0)]),
new Difficulty(98, "UDK姉妹乱入クエスト(MZ姉貴戦)", true, [new Enemy(Chara.all[130], 1.0), new Enemy(Chara.all[126], 0.21), new Enemy(Chara.all[5], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[4], 0.0)]),
new Difficulty(99, "UDK姉妹乱入クエスト(AZS姉貴戦)", true, [new Enemy(Chara.all[131], 1.0), new Enemy(Chara.all[127], 0.21), new Enemy(Chara.all[17], 0.0), new Enemy(Chara.all[11], 0.0), new Enemy(Chara.all[14], 0.0)]),
new Difficulty(100, "UDK姉妹乱入クエスト(RI姉貴戦)", true, [new Enemy(Chara.all[132], 1.0), new Enemy(Chara.all[128], 0.21), new Enemy(Chara.all[11], 0.0), new Enemy(Chara.all[12], 0.0), new Enemy(Chara.all[7], 0.0)]),
new Difficulty(101, "UDK姉妹乱入クエスト(朗読兄貴戦)", false, [new Enemy(Chara.all[133], 1.0), new Enemy(Chara.all[133], 0.0), new Enemy(Chara.all[133], 0.0), new Enemy(Chara.all[133], 0.0), new Enemy(Chara.all[1], 1.0)]),
...
new Difficulty(103, "立　教　大　学(ADV)", true, [new Enemy(Chara.all[15], 0.11), new Enemy(Chara.all[14], 0.0), new Enemy(Chara.all[12], 0.0), new Enemy(Chara.all[16], 0.31), new Enemy(Chara.all[52], 1.0), new Enemy(Chara.all[44], 0.51), new Enemy(Chara.all[11], 0.0), new Enemy(Chara.all[43], 0.51), new Enemy(Chara.all[22], 0.51), new Enemy(Chara.all[137], 1.0), new Enemy(Chara.all[5], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[53], 1.0), new Enemy(Chara.all[128], 1.0), new Enemy(Chara.all[7], 0.0), new Enemy(Chara.all[11], 0.0), new Enemy(Chara.all[134], 0.31), new Enemy(Chara.all[18], 0.0), new Enemy(Chara.all[39], 0.0), new Enemy(Chara.all[127], 1.0), new Enemy(Chara.all[54], 1.0), new Enemy(Chara.all[26], 0.0), new Enemy(Chara.all[70], 1.0), new Enemy(Chara.all[67], 1.0), new Enemy(Chara.all[138], 1.0), new Enemy(Chara.all[35], 0.51), new Enemy(Chara.all[32], 0.0), new Enemy(Chara.all[33], 0.0), new Enemy(Chara.all[34], 0.0), new Enemy(Chara.all[126], 1.0), new Enemy(Chara.all[72], 0.0), new Enemy(Chara.all[28], 0.0), new Enemy(Chara.all[17], 1.0), new Enemy(Chara.all[102], 1.0), new Enemy(Chara.all[103], 1.0), new Enemy(Chara.all[101], 1.0), new Enemy(Chara.all[141], 0.21), new Enemy(Chara.all[139], 0.31), new Enemy(Chara.all[137], 0.31), new Enemy(Chara.all[138], 0.31), new Enemy(Chara.all[35], 0.31)]),
new Difficulty(104, "立　教　大　学(EXH)", true, [new Enemy(Chara.all[135], 0.31), new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[5], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[52], 0.0), new Enemy(Chara.all[44], 0.0), new Enemy(Chara.all[71], 0.0), new Enemy(Chara.all[43], 0.0), new Enemy(Chara.all[39], 0.0), new Enemy(Chara.all[137], 1.0), new Enemy(Chara.all[67], 0.0), new Enemy(Chara.all[95], 0.0), new Enemy(Chara.all[94], 0.0), new Enemy(Chara.all[127], 1.0), new Enemy(Chara.all[134], 1.0), new Enemy(Chara.all[85], 0.0), new Enemy(Chara.all[23], 0.0), new Enemy(Chara.all[11], 0.0), new Enemy(Chara.all[69], 0.0), new Enemy(Chara.all[53], 0.0), new Enemy(Chara.all[128], 1.0), new Enemy(Chara.all[7], 0.0), new Enemy(Chara.all[35], 0.0), new Enemy(Chara.all[107], 0.0), new Enemy(Chara.all[138], 1.0), new Enemy(Chara.all[35], 0.51), new Enemy(Chara.all[32], 0.0), new Enemy(Chara.all[33], 0.0), new Enemy(Chara.all[34], 0.0), new Enemy(Chara.all[136], 0.31), new Enemy(Chara.all[21], 0.0), new Enemy(Chara.all[20], 0.0), new Enemy(Chara.all[104], 0.0), new Enemy(Chara.all[54], 0.0), new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[19], 0.0), new Enemy(Chara.all[26], 0.0), new Enemy(Chara.all[14], 0.0), new Enemy(Chara.all[139], 0.0), new Enemy(Chara.all[70], 0.0), new Enemy(Chara.all[126], 0.0), new Enemy(Chara.all[93], 0.0), new Enemy(Chara.all[88], 0.0), new Enemy(Chara.all[105], 1.0), new Enemy(Chara.all[103], 0.0), new Enemy(Chara.all[101], 0.0), new Enemy(Chara.all[106], 1.0), new Enemy(Chara.all[11], 0.0), new Enemy(Chara.all[138], 0.0), new Enemy(Chara.all[141], 0.51), new Enemy(Chara.all[139], 0.51), new Enemy(Chara.all[137], 0.51), new Enemy(Chara.all[138], 0.51), new Enemy(Chara.all[140], 0.31)]),
new Difficulty(105, "立　教　大　学(LEG)", true, [new Enemy(Chara.all[135], 1.0), new Enemy(Chara.all[118], 0.0), new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[5], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[52], 0.0), new Enemy(Chara.all[44], 0.0), new Enemy(Chara.all[10], 0.0), new Enemy(Chara.all[43], 0.0), new Enemy(Chara.all[39], 0.0), new Enemy(Chara.all[137], 1.0), new Enemy(Chara.all[67], 0.0), new Enemy(Chara.all[95], 0.0), new Enemy(Chara.all[94], 0.0), new Enemy(Chara.all[127], 1.0), new Enemy(Chara.all[134], 1.0), new Enemy(Chara.all[85], 0.0), new Enemy(Chara.all[23], 0.0), new Enemy(Chara.all[11], 0.0), new Enemy(Chara.all[69], 0.0), new Enemy(Chara.all[53], 0.0), new Enemy(Chara.all[128], 1.0), new Enemy(Chara.all[7], 0.0), new Enemy(Chara.all[35], 0.0), new Enemy(Chara.all[107], 0.0), new Enemy(Chara.all[106], 1.0), new Enemy(Chara.all[38], 0.0), new Enemy(Chara.all[95], 0.0), new Enemy(Chara.all[41], 0.0), new Enemy(Chara.all[138], 1.0), new Enemy(Chara.all[35], 0.51), new Enemy(Chara.all[32], 0.0), new Enemy(Chara.all[33], 0.0), new Enemy(Chara.all[34], 0.0), new Enemy(Chara.all[136], 1.0), new Enemy(Chara.all[21], 0.0), new Enemy(Chara.all[20], 0.0), new Enemy(Chara.all[18], 0.0), new Enemy(Chara.all[54], 0.0), new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[19], 1.0), new Enemy(Chara.all[26], 0.0), new Enemy(Chara.all[14], 0.0), new Enemy(Chara.all[139], 0.0), new Enemy(Chara.all[70], 0.0), new Enemy(Chara.all[126], 0.0), new Enemy(Chara.all[93], 0.0), new Enemy(Chara.all[88], 0.0), new Enemy(Chara.all[140], 0.0), new Enemy(Chara.all[109], 0.0), new Enemy(Chara.all[105], 1.0), new Enemy(Chara.all[8], 0.0), new Enemy(Chara.all[141], 1.0), new Enemy(Chara.all[142], 0.31), new Enemy(Chara.all[137], 0.51), new Enemy(Chara.all[139], 0.51), new Enemy(Chara.all[140], 0.31), new Enemy(Chara.all[143], 1.0), new Enemy(Chara.all[141], 1.0), new Enemy(Chara.all[142], 1.0)]),
new Difficulty(106, "人間の里のゲーム屋(EAS)", false, [new Enemy(Chara.all[157], 1.0), new Enemy(Chara.all[104], 1.0), new Enemy(Chara.all[54], 1.0), new Enemy(Chara.all[102], 1.0), new Enemy(Chara.all[13], 1.0), new Enemy(Chara.all[52], 1.0), new Enemy(Chara.all[101], 1.0), new Enemy(Chara.all[128], 1.0), new Enemy(Chara.all[53], 1.0), new Enemy(Chara.all[103], 1.0), new Enemy(Chara.all[126], 1.0), new Enemy(Chara.all[127], 1.0), new Enemy(Chara.all[175], 0.31), new Enemy(Chara.all[10], 0.31), new Enemy(Chara.all[90], 0.31)]),
new Difficulty(107, "人間の里のゲーム屋(ADV)", false, [new Enemy(Chara.all[39], 1.0), new Enemy(Chara.all[21], 1.0), new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[20], 1.0), new Enemy(Chara.all[157], 1.0), new Enemy(Chara.all[104], 1.0), new Enemy(Chara.all[54], 1.0), new Enemy(Chara.all[42], 1.0), new Enemy(Chara.all[102], 1.0), new Enemy(Chara.all[13], 1.0), new Enemy(Chara.all[52], 1.0), new Enemy(Chara.all[88], 1.0), new Enemy(Chara.all[105], 1.0), new Enemy(Chara.all[8], 1.0), new Enemy(Chara.all[7], 1.0), new Enemy(Chara.all[127], 1.0), new Enemy(Chara.all[101], 1.0), new Enemy(Chara.all[128], 1.0), new Enemy(Chara.all[53], 1.0), new Enemy(Chara.all[95], 1.0), new Enemy(Chara.all[103], 1.0), new Enemy(Chara.all[126], 1.0), new Enemy(Chara.all[16], 1.0), new Enemy(Chara.all[147], 1.0), new Enemy(Chara.all[175], 0.51), new Enemy(Chara.all[40], 0.31), new Enemy(Chara.all[90], 0.31), new Enemy(Chara.all[35], 0.31), new Enemy(Chara.all[90], 0.31)]),
new Difficulty(108, "人間の里のゲーム屋(EXH)", false, [new Enemy(Chara.all[21], 1.0), new Enemy(Chara.all[39], 1.0), new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[20], 1.0), new Enemy(Chara.all[105], 1.0), new Enemy(Chara.all[8], 1.0), new Enemy(Chara.all[51], 1.0), new Enemy(Chara.all[127], 1.0), new Enemy(Chara.all[89], 1.0), new Enemy(Chara.all[88], 1.0), new Enemy(Chara.all[126], 1.0), new Enemy(Chara.all[52], 1.0), new Enemy(Chara.all[159], 1.0), new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[67], 1.0), new Enemy(Chara.all[19], 1.0), new Enemy(Chara.all[154], 1.0), new Enemy(Chara.all[54], 1.0), new Enemy(Chara.all[157], 1.0), new Enemy(Chara.all[128], 1.0), new Enemy(Chara.all[169], 1.0), new Enemy(Chara.all[22], 1.0), new Enemy(Chara.all[74], 1.0), new Enemy(Chara.all[75], 1.0), new Enemy(Chara.all[59], 1.0), new Enemy(Chara.all[147], 1.0), new Enemy(Chara.all[27], 1.0), new Enemy(Chara.all[7], 1.0), new Enemy(Chara.all[60], 1.0), new Enemy(Chara.all[35], 1.0), new Enemy(Chara.all[72], 1.0), new Enemy(Chara.all[41], 1.0), new Enemy(Chara.all[111], 1.0), new Enemy(Chara.all[44], 1.0), new Enemy(Chara.all[43], 1.0), new Enemy(Chara.all[11], 1.0), new Enemy(Chara.all[176], 1.0), new Enemy(Chara.all[175], 0.31), new Enemy(Chara.all[90], 0.31), new Enemy(Chara.all[40], 0.31)]),
new Difficulty(109, "まりスト例大祭(EAS)", false, [new Enemy(Chara.all[102], 1.0), new Enemy(Chara.all[101], 1.0), new Enemy(Chara.all[103], 1.0), new Enemy(Chara.all[62], 1.0), new Enemy(Chara.all[63], 1.0), new Enemy(Chara.all[64], 1.0), new Enemy(Chara.all[180], 0.31), new Enemy(Chara.all[52], 0.31), new Enemy(Chara.all[53], 0.31), new Enemy(Chara.all[54], 0.31)]),
new Difficulty(110, "まりスト例大祭(ADV)", false, [new Enemy(Chara.all[76], 1.0), new Enemy(Chara.all[77], 1.0), new Enemy(Chara.all[78], 1.0), new Enemy(Chara.all[57], 1.0), new Enemy(Chara.all[58], 1.0), new Enemy(Chara.all[59], 1.0), new Enemy(Chara.all[52], 1.0), new Enemy(Chara.all[53], 1.0), new Enemy(Chara.all[54], 1.0), new Enemy(Chara.all[126], 1.0), new Enemy(Chara.all[127], 1.0), new Enemy(Chara.all[128], 1.0), new Enemy(Chara.all[180], 0.51), new Enemy(Chara.all[79], 1.0), new Enemy(Chara.all[81], 1.0), new Enemy(Chara.all[80], 1.0)]),
new Difficulty(111, "まりスト例大祭(EXH)", false, [new Enemy(Chara.all[60], 1.0), new Enemy(Chara.all[88], 1.0), new Enemy(Chara.all[78], 1.0), new Enemy(Chara.all[76], 1.0), new Enemy(Chara.all[77], 1.0), new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[26], 1.0), new Enemy(Chara.all[27], 1.0), new Enemy(Chara.all[137], 1.0), new Enemy(Chara.all[140], 1.0), new Enemy(Chara.all[16], 1.0), new Enemy(Chara.all[15], 1.0), new Enemy(Chara.all[139], 1.0), new Enemy(Chara.all[138], 1.0), new Enemy(Chara.all[5], 1.0), new Enemy(Chara.all[6], 1.0), new Enemy(Chara.all[141], 1.0), new Enemy(Chara.all[142], 1.0), new Enemy(Chara.all[13], 1.0), new Enemy(Chara.all[106], 1.0), new Enemy(Chara.all[65], 1.0), new Enemy(Chara.all[62], 1.0), new Enemy(Chara.all[63], 1.0), new Enemy(Chara.all[64], 1.0), new Enemy(Chara.all[180], 1.0), new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[19], 1.0), new Enemy(Chara.all[79], 1.0)]),
new Difficulty(112, "まりスト例大祭(LEG)", false, [new Enemy(Chara.all[18], 0.0), new Enemy(Chara.all[19], 0.0), new Enemy(Chara.all[127], 0.0), new Enemy(Chara.all[76], 0.02), new Enemy(Chara.all[79], 0.0), new Enemy(Chara.all[141], 0.0), new Enemy(Chara.all[140], 0.0), new Enemy(Chara.all[77], 0.0), new Enemy(Chara.all[136], 0.0), new Enemy(Chara.all[31], 0.0), new Enemy(Chara.all[82], 0.0), new Enemy(Chara.all[35], 0.0), new Enemy(Chara.all[72], 0.0), new Enemy(Chara.all[65], 0.0), new Enemy(Chara.all[158], 0.0), new Enemy(Chara.all[7], 0.0), new Enemy(Chara.all[53], 0.0), new Enemy(Chara.all[59], 0.0), new Enemy(Chara.all[27], 0.0), new Enemy(Chara.all[7], 0.0), new Enemy(Chara.all[147], 0.0), new Enemy(Chara.all[143], 0.0), new Enemy(Chara.all[175], 0.0), new Enemy(Chara.all[142], 0.0), new Enemy(Chara.all[126], 0.0), new Enemy(Chara.all[153], 0.0), new Enemy(Chara.all[57], 0.0), new Enemy(Chara.all[58], 0.0), new Enemy(Chara.all[104], 0.0), new Enemy(Chara.all[81], 0.0), new Enemy(Chara.all[128], 0.0), new Enemy(Chara.all[51], 0.0), new Enemy(Chara.all[4], 0.0), new Enemy(Chara.all[137], 0.0), new Enemy(Chara.all[180], 1.0), new Enemy(Chara.all[17], 0.0), new Enemy(Chara.all[54], 0.0), new Enemy(Chara.all[95], 0.0), new Enemy(Chara.all[40], 0.0), new Enemy(Chara.all[181], 1.0), new Enemy(Chara.all[0], 0.0), new Enemy(Chara.all[1], 0.0), new Enemy(Chara.all[2], 0.0), new Enemy(Chara.all[9], 0.0)]),
new Difficulty(113, "イケメン三銃士乱入クエスト(チャリオット平野戦)", false, [new Enemy(Chara.all[182], 1.0), new Enemy(Chara.all[68], 0.0), new Enemy(Chara.all[30], 0.0), new Enemy(Chara.all[127], 0.0), new Enemy(Chara.all[167], 0.0)]),
new Difficulty(114, "イケメン三銃士乱入クエスト(剣聖おじさん戦)", false, [new Enemy(Chara.all[183], 1.0), new Enemy(Chara.all[104], 0.0), new Enemy(Chara.all[86], 0.0), new Enemy(Chara.all[57], 0.0), new Enemy(Chara.all[16], 0.0)]),
new Difficulty(115, "イケメン三銃士乱入クエスト(破面KBTIT戦)", false, [new Enemy(Chara.all[184], 1.0), new Enemy(Chara.all[147], 0.0), new Enemy(Chara.all[7], 0.0), new Enemy(Chara.all[27], 0.0), new Enemy(Chara.all[158], 0.0)]),
new Difficulty(116, "イケメン三銃士乱入クエスト(AKMRくん戦)", false, [new Enemy(Chara.all[185], 1.0), new Enemy(Chara.all[183], 1.0), new Enemy(Chara.all[184], 0.0), new Enemy(Chara.all[182], 0.0), new Enemy(Chara.all[23], 0.0)]),
new Difficulty(117, "セミ兄貴の森(EAS)", false, [new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[50], 0.31), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0)]),
new Difficulty(118, "セミ兄貴の森(ADV)", false, [new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[50], 0.61), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0)]),
new Difficulty(119, "セミ兄貴の森(EXH)", false, [new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[50], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0)]),
new Difficulty(120, "セミ兄貴の森(LEG)", false, [new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[50], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[109], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[112], 1.0), new Enemy(Chara.all[50], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[109], 1.0)]),
new Difficulty(121, "妖精の森(EAS)", false, [new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[47], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[46], 0.0), new Enemy(Chara.all[118], 1.0), new Enemy(Chara.all[119], 1.0), new Enemy(Chara.all[121], 0.0), new Enemy(Chara.all[122], 0.0), new Enemy(Chara.all[120], 0.0)]),
new Difficulty(122, "妖精の森(ADV)", false, [new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[47], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[46], 0.0), new Enemy(Chara.all[5], 1.0), new Enemy(Chara.all[49], 0.0), new Enemy(Chara.all[118], 1.0), new Enemy(Chara.all[119], 0.51), new Enemy(Chara.all[121], 1.0), new Enemy(Chara.all[122], 1.0), new Enemy(Chara.all[120], 1.0)]),
new Difficulty(123, "妖精の森(EXH)", false, [new Enemy(Chara.all[118], 1.0), new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[7], 0.0), new Enemy(Chara.all[47], 0.0), new Enemy(Chara.all[119], 1.0), new Enemy(Chara.all[5], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[118], 0.0), new Enemy(Chara.all[46], 0.0), new Enemy(Chara.all[120], 1.0), new Enemy(Chara.all[121], 0.0), new Enemy(Chara.all[123], 1.0), new Enemy(Chara.all[118], 1.0), new Enemy(Chara.all[45], 0.0), new Enemy(Chara.all[122], 1.0), new Enemy(Chara.all[49], 0.0), new Enemy(Chara.all[5], 1.0), new Enemy(Chara.all[7], 1.0), new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[118], 1.0), new Enemy(Chara.all[120], 1.0), new Enemy(Chara.all[121], 1.0), new Enemy(Chara.all[124], 1.0), new Enemy(Chara.all[123], 1.0)]),
new Difficulty(124, "妖精の森(LEG)", false, [new Enemy(Chara.all[118], 1.0), new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[157], 0.0), new Enemy(Chara.all[7], 0.0), new Enemy(Chara.all[47], 0.0), new Enemy(Chara.all[119], 1.0), new Enemy(Chara.all[5], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[118], 0.0), new Enemy(Chara.all[46], 0.0), new Enemy(Chara.all[177], 1.0), new Enemy(Chara.all[5], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[122], 0.0), new Enemy(Chara.all[46], 0.0), new Enemy(Chara.all[120], 1.0), new Enemy(Chara.all[121], 0.0), new Enemy(Chara.all[123], 1.0), new Enemy(Chara.all[118], 1.0), new Enemy(Chara.all[45], 0.0), new Enemy(Chara.all[122], 1.0), new Enemy(Chara.all[49], 0.0), new Enemy(Chara.all[5], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[178], 1.0), new Enemy(Chara.all[119], 0.0), new Enemy(Chara.all[118], 1.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[179], 1.0), new Enemy(Chara.all[120], 1.0), new Enemy(Chara.all[118], 1.0), new Enemy(Chara.all[124], 1.0)])
];
