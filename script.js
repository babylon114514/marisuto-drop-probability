...
new Difficulty(146, "感情こころ乱入クエスト(怒声の妖精面戦)", false, [new Enemy(Chara.all[244], 0.0), new Enemy(Chara.all[142], 0.0), new Enemy(Chara.all[93], 0.0), new Enemy(Chara.all[101], 0.0), new Enemy(Chara.all[171], 0.0)]),
new Difficulty(147, "感情こころ乱入クエスト(憂心の茄子面戦)", false, [new Enemy(Chara.all[244], 0.0), new Enemy(Chara.all[37], 0.0), new Enemy(Chara.all[152], 0.0), new Enemy(Chara.all[54], 0.0), new Enemy(Chara.all[77], 0.0)]),
new Difficulty(148, "感情こころ乱入クエスト(歓喜の半霊面戦)", false, [new Enemy(Chara.all[244], 0.0), new Enemy(Chara.all[157], 0.0), new Enemy(Chara.all[58], 0.0), new Enemy(Chara.all[191], 0.0), new Enemy(Chara.all[17], 0.0)]),
new Difficulty(149, "感情こころ乱入クエスト(狂喜の聖獣面戦)", false, [new Enemy(Chara.all[244], 0.0), new Enemy(Chara.all[197], 0.0), new Enemy(Chara.all[88], 0.0), new Enemy(Chara.all[95], 0.0), new Enemy(Chara.all[233], 0.0)]),
new Difficulty(150, "感情こころ乱入クエスト(憂嘆の長友面戦)", false, [new Enemy(Chara.all[244], 0.0), new Enemy(Chara.all[35], 0.0), new Enemy(Chara.all[128], 0.0), new Enemy(Chara.all[53], 0.0), new Enemy(Chara.all[76], 0.0)]),
