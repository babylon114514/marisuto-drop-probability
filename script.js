...
new Chara(43, "SIY", 43),
new Chara(44, "GO", 44),
new Chara(45, "レッドセミ兄貴", 122),
new Chara(46, "ブルーセミ兄貴", 123),
new Chara(47, "セミ兄貴", 124),
new Chara(48, "光に満ちたセミ兄貴", 125),
new Chara(49, "闇に堕ちたセミ兄貴", 126),
new Chara(50, "メガカイロSIK", 127),
new Chara(51, "サマーMSTA姉貴", 137),
new Chara(52, "バレンタインRIM", 141),
new Chara(53, "バレンタインUDK", 142),
new Chara(54, "バレンタインALC", 143),
new Chara(55, "YKR姉貴", 160),
new Chara(56, "邪神GO", 161),
new Chara(57, "SNE姉貴", 96),
new Chara(58, "SWK様", 97),
new Chara(59, "風神KNK", 98),
new Chara(60, "神々の頂点SWK", 99),
new Chara(61, "イワナを焼くUDK", 90),
new Chara(62, "サマーRIM姉貴", 138),
new Chara(63, "サマーUDK姉貴", 139),
new Chara(64, "サマーALC姉貴", 140),
new Chara(65, "サマーHZR姉貴", 144),
new Chara(66, "サマーピンキー姉貴", 150),
...
new Chara(76, "YMMちゃん", 103),
new Chara(77, "PLSY姉貴", 104),
new Chara(78, "YUG姉貴", 105),
new Chara(79, "STR姉貴", 106),
new Chara(80, "ORN姉貴", 107),
new Chara(81, "KISちゃん", 108),
new Chara(82, "太陽神NDK", 109),
...
new Chara(90, "たまドラ田中", 159),
new Chara(91, "MMJ姉貴", 136),
new Chara(92, "いなり男", 61),
new Chara(93, "AKG", 62),
new Chara(94, "関西クレーマー", 63),
new Chara(95, "現場監督", 64),
new Chara(96, "変態郵便屋", 84),
new Chara(97, "インパルスITKR", 85),
new Chara(98, "小森", 86),
new Chara(99, "ホリ・トオル", 87),
new Chara(100, "ラザマリナ", 91),
...
new Chara(109, "植木鉢くん", 83),
new Chara(110, "PSR姉貴", 100),
new Chara(111, "化物と化したPSR姉貴", 101),
new Chara(112, "全てを狩る先輩", 128),
new Chara(113, "花嫁と化した先輩", 145),
new Chara(114, "嫁TIT", 146),
new Chara(115, "花嫁ピンキー", 147),
new Chara(116, "ノンケスレイヤー", 148),
new Chara(117, "BSTIT", 149),
new Chara(118, "ビリー兄貴", 129),
new Chara(119, "木吉カズヤ", 130),
new Chara(120, "井上カブレラ", 131),
new Chara(121, "いかりやビオランテ", 132),
new Chara(122, "TDNコスギ", 133),
new Chara(123, "赤さん", 134),
new Chara(124, "VAN様", 135),
new Chara(125, "カグラ=ウヅキ", 92),
new Chara(126, "ESKちゃん", 151),
new Chara(127, "YW姉貴", 152),
new Chara(128, "ITUASK", 153),
new Chara(129, "バンホーテンダー", 93),
new Chara(130, "MZ姉貴", 154),
new Chara(131, "AZS姉貴", 155),
new Chara(132, "RI姉貴", 156),
new Chara(133, "朗読兄貴", 157),
new Chara(134, "デビルひで", 111),
new Chara(135, "ナイトメアビリー兄貴", 112),
new Chara(136, "ベルモンド先輩", 113),
new Chara(137, "ナイトメアMIRN姉貴", 114),
new Chara(138, "ナイトメアKSDB姉貴", 115),
new Chara(139, "ナイトメアPCLY姉貴", 116),
new Chara(140, "ナイトメアSKY姉貴", 117),
new Chara(141, "ナイトメアRMLA姉貴", 118),
new Chara(142, "ナイトメアFLNちゃん", 119),
new Chara(143, "スカーレット内閣", 120),
new Chara(144, "黄金のSWK様", 102),
new Chara(145, "ZNM姉貴", 110),
...
new Chara(154, "中盤に出てくる鳥", 158),
new Chara(155, "ダークロウ先輩", 94),
new Chara(156, "交通整理DIちゃん", 82),
new Chara(157, "世界のトオノ", 88),
new Chara(158, "ビューティ先輩", 89),
new Chara(159, "ミミックおばさん", 121),
new Chara(160, "メカNDK", 95)
];
...
new Quest(6, "下北沢", false, [new Difficulty("EAS", [new Wave([new Enemy(Chara.all[4], 1.0), new Enemy(Chara.all[3], 1.0), new Enemy(Chara.all[5], 1.0)]), new Wave([new Enemy(Chara.all[10], 1.0), new Enemy(Chara.all[9], 1.0), new Enemy(Chara.all[6], 1.0)]), new Wave([new Enemy(Chara.all[14], 0.31), new Enemy(Chara.all[12], 0.31), new Enemy(Chara.all[11], 0.31)]), new Wave([new Enemy(Chara.all[17], 0.11), new Enemy(Chara.all[7], 0.11), new Enemy(Chara.all[8], 1.0)]), new Wave([new Enemy(Chara.all[18], 0.0), new Enemy(Chara.all[19], 0.0), new Enemy(Chara.all[20], 0.0), new Enemy(Chara.all[21], 0.0)])]), new Difficulty("ADV", [new Wave([new Enemy(Chara.all[4], 1.0), new Enemy(Chara.all[3], 1.0), new Enemy(Chara.all[5], 1.0)]), new Wave([new Enemy(Chara.all[10], 1.0), new Enemy(Chara.all[9], 1.0), new Enemy(Chara.all[6], 1.0)]), new Wave([new Enemy(Chara.all[14], 0.31), new Enemy(Chara.all[12], 0.31), new Enemy(Chara.all[11], 0.31)]), new Wave([new Enemy(Chara.all[17], 0.51), new Enemy(Chara.all[7], 1.0), new Enemy(Chara.all[8], 1.0)]), new Wave([new Enemy(Chara.all[18], 0.51), new Enemy(Chara.all[19], 0.51), new Enemy(Chara.all[20], 1.0), new Enemy(Chara.all[21], 0.0)])]), new Difficulty("EXH", [new Wave([new Enemy(Chara.all[4], 1.0), new Enemy(Chara.all[3], 1.0), new Enemy(Chara.all[5], 1.0)]), new Wave([new Enemy(Chara.all[10], 1.0), new Enemy(Chara.all[9], 1.0), new Enemy(Chara.all[6], 1.0)]), new Wave([new Enemy(Chara.all[14], 1.0), new Enemy(Chara.all[12], 1.0), new Enemy(Chara.all[11], 1.0)]), new Wave([new Enemy(Chara.all[17], 1.0), new Enemy(Chara.all[7], 1.0), new Enemy(Chara.all[8], 1.0)]), new Wave([new Enemy(Chara.all[22], 1.0), new Enemy(Chara.all[19], 1.0), new Enemy(Chara.all[20], 1.0), new Enemy(Chara.all[21], 0.51)])]), new Difficulty("LEG", [new Wave([new Enemy(Chara.all[3], 1.0), new Enemy(Chara.all[4], 1.0)]), new Wave([new Enemy(Chara.all[5], 1.0), new Enemy(Chara.all[8], 1.0), new Enemy(Chara.all[6], 1.0)]), new Wave([new Enemy(Chara.all[156], 0.51), new Enemy(Chara.all[9], 1.0)]), new Wave([new Enemy(Chara.all[12], 1.0), new Enemy(Chara.all[11], 1.0)]), new Wave([new Enemy(Chara.all[15], 1.0), new Enemy(Chara.all[14], 1.0), new Enemy(Chara.all[10], 1.0)]), new Wave([new Enemy(Chara.all[15], 1.0), new Enemy(Chara.all[13], 1.0), new Enemy(Chara.all[16], 1.0)]), new Wave([new Enemy(Chara.all[158], 0.51), new Enemy(Chara.all[157], 0.51), new Enemy(Chara.all[7], 1.0), new Enemy(Chara.all[109], 1.0)])])]),
new Quest(7, "新宿調教センター", false, [new Difficulty("EAS", [new Wave([new Enemy(Chara.all[23], 1.0), new Enemy(Chara.all[19], 1.0), new Enemy(Chara.all[20], 1.0)]), new Wave([new Enemy(Chara.all[24], 1.0), new Enemy(Chara.all[23], 1.0), new Enemy(Chara.all[25], 1.0)]), new Wave([new Enemy(Chara.all[32], 1.0), new Enemy(Chara.all[20], 1.0), new Enemy(Chara.all[23], 1.0)]), new Wave([new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[23], 1.0), new Enemy(Chara.all[25], 1.0)]), new Wave([new Enemy(Chara.all[27], 0.11), new Enemy(Chara.all[18], 0.11), new Enemy(Chara.all[23], 0.11), new Enemy(Chara.all[28], 0.0)])]), new Difficulty("ADV", [new Wave([new Enemy(Chara.all[23], 1.0), new Enemy(Chara.all[19], 1.0), new Enemy(Chara.all[20], 1.0)]), new Wave([new Enemy(Chara.all[24], 1.0), new Enemy(Chara.all[23], 1.0), new Enemy(Chara.all[25], 1.0)]), new Wave([new Enemy(Chara.all[32], 1.0), new Enemy(Chara.all[20], 1.0), new Enemy(Chara.all[23], 1.0)]), new Wave([new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[23], 1.0), new Enemy(Chara.all[25], 1.0)]), new Wave([new Enemy(Chara.all[27], 0.51), new Enemy(Chara.all[18], 0.51), new Enemy(Chara.all[23], 0.51), new Enemy(Chara.all[28], 0.51)])]), new Difficulty("EXH", [new Wave([new Enemy(Chara.all[23], 1.0), new Enemy(Chara.all[19], 1.0), new Enemy(Chara.all[20], 1.0)]), new Wave([new Enemy(Chara.all[24], 1.0), new Enemy(Chara.all[23], 1.0), new Enemy(Chara.all[25], 1.0)]), new Wave([new Enemy(Chara.all[32], 1.0), new Enemy(Chara.all[20], 1.0), new Enemy(Chara.all[23], 1.0)]), new Wave([new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[23], 1.0), new Enemy(Chara.all[25], 1.0)]), new Wave([new Enemy(Chara.all[27], 1.0), new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[23], 1.0), new Enemy(Chara.all[28], 1.0)])])]),
