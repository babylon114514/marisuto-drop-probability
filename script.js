...
new Chara(43, "SIY", 45),
new Chara(44, "GO", 46),
new Chara(45, "レッドセミ兄貴", 178),
new Chara(46, "ブルーセミ兄貴", 179),
new Chara(47, "セミ兄貴", 180),
new Chara(48, "光に満ちたセミ兄貴", 181),
new Chara(49, "闇に堕ちたセミ兄貴", 182),
new Chara(50, "メガカイロSIK", 183),
new Chara(51, "サマーMSTA姉貴", 207),
new Chara(52, "バレンタインRIM", 211),
new Chara(53, "バレンタインUDK", 212),
new Chara(54, "バレンタインALC", 213),
new Chara(55, "YKR姉貴", 262),
new Chara(56, "邪神GO", 263),
new Chara(57, "SNE姉貴", 143),
new Chara(58, "SWK様", 144),
new Chara(59, "風神KNK", 145),
new Chara(60, "神々の頂点SWK", 146),
new Chara(61, "イワナを焼くUDK", 136),
new Chara(62, "サマーRIM姉貴", 208),
new Chara(63, "サマーUDK姉貴", 209),
new Chara(64, "サマーALC姉貴", 210),
new Chara(65, "サマーHZR姉貴", 214),
new Chara(66, "サマーピンキー姉貴", 220),
...
new Chara(76, "YMMちゃん", 150),
new Chara(77, "PLSY姉貴", 151),
new Chara(78, "YUG姉貴", 152),
new Chara(79, "STR姉貴", 153),
new Chara(80, "ORN姉貴", 154),
new Chara(81, "KISちゃん", 155),
new Chara(82, "太陽神NDK", 156),
...
new Chara(90, "たまドラ田中", 242),
new Chara(91, "MMJ姉貴", 206),
...
new Chara(110, "PSR姉貴", 147),
new Chara(111, "化物と化したPSR姉貴", 148),
new Chara(112, "全てを狩る先輩", 184),
new Chara(113, "花嫁と化した先輩", 215),
new Chara(114, "嫁TIT", 216),
new Chara(115, "花嫁ピンキー", 217),
new Chara(116, "ノンケスレイヤー", 218),
new Chara(117, "BSTIT", 219),
new Chara(118, "ビリー兄貴", 185),
new Chara(119, "木吉カズヤ", 186),
new Chara(120, "井上カブレラ", 187),
new Chara(121, "いかりやビオランテ", 188),
new Chara(122, "TDNコスギ", 189),
new Chara(123, "赤さん", 190),
new Chara(124, "VAN様", 191),
new Chara(125, "カグラ=ウヅキ", 138),
new Chara(126, "ESKちゃん", 221),
new Chara(127, "YW姉貴", 222),
new Chara(128, "ITUASK", 223),
new Chara(129, "バンホーテンダー", 139),
new Chara(130, "MZ姉貴", 224),
new Chara(131, "AZS姉貴", 225),
new Chara(132, "RI姉貴", 226),
new Chara(133, "朗読兄貴", 227),
new Chara(134, "デビルひで", 158),
new Chara(135, "ナイトメアビリー兄貴", 159),
new Chara(136, "ベルモンド先輩", 160),
new Chara(137, "ナイトメアMIRN姉貴", 161),
new Chara(138, "ナイトメアKSDB姉貴", 162),
new Chara(139, "ナイトメアPCLY姉貴", 163),
new Chara(140, "ナイトメアSKY姉貴", 164),
new Chara(141, "ナイトメアRMLA姉貴", 165),
new Chara(142, "ナイトメアFLNちゃん", 166),
new Chara(143, "スカーレット内閣", 167),
new Chara(144, "黄金のSWK様", 149),
new Chara(145, "ZNM姉貴", 157),
...
new Chara(155, "中盤に出てくる鳥", 241),
new Chara(156, "ダークロウ先輩", 141),
new Chara(157, "交通整理DIちゃん", 119),
new Chara(158, "世界のトオノ", 125),
new Chara(159, "ビューティ先輩", 126),
new Chara(160, "ミミックおばさん", 168),
new Chara(161, "メカNDK", 142),
new Chara(162, "AY姉貴", 236),
new Chara(163, "TNS姉貴", 237),
new Chara(164, "HTT姉貴", 238),
new Chara(165, "MDCNちゃん", 239),
new Chara(166, "RNNSK兄貴", 240),
...
new Chara(175, "Y.AOI", 169),
new Chara(176, "メガMTGRS先輩", 170),
new Chara(177, "須藤さん", 192),
new Chara(178, "池田茂美", 193),
new Chara(179, "妖精王チチラルー", 194),
new Chara(180, "ALISON兄貴", 233),
new Chara(181, "ZUN", 234),
new Chara(182, "チャリオット平野", 228),
new Chara(183, "剣聖おじさん", 229),
new Chara(184, "破面KBTIT", 230),
new Chara(185, "AKMRくん", 231),
...
new Chara(197, "完全勝利した淫夢くんUC", 243),
new Chara(198, "風来人RU", 195),
new Chara(199, "ESKドラゴン", 196),
new Chara(200, "ジャボテンダーALC", 197),
new Chara(201, "多脚ひで", 198),
new Chara(202, "ピン鬼", 199),
new Chara(203, "ダークドレアム先輩", 200),
new Chara(204, "釣リスマスおばさん", 244),
new Chara(205, "GTさん", 128),
new Chara(206, "超能力者ONDISK", 129),
new Chara(207, "NZRN", 171),
new Chara(208, "KGSちゃん", 172),
new Chara(209, "ICRN姉貴", 173),
new Chara(210, "MRS姉貴", 174),
new Chara(211, "SYOU姉貴", 175),
new Chara(212, "HZR姉貴", 176),
new Chara(213, "NUEちゃん", 177),
...
new Chara(233, "斬月・真SIK", 235),
new Chara(234, "淫夢之一太刀SIK", 245),
new Chara(235, "ズ・ゴオマ・グ", 130),
new Chara(236, "野獣父", 131),
new Chara(237, "天地人平野", 232),
new Chara(238, "バレンタインBNKRG", 246),
new Chara(239, "バレンタインKNN", 247),
new Chara(240, "バレンタインSNNN", 248),
new Chara(241, "バレンタインSNE", 249),
new Chara(242, "バレンタインSWK様", 250),
new Chara(243, "チョコレート先輩", 251),
new Chara(244, "HTNこころ", 252),
new Chara(245, "タカダキミヒコ量産機", 132),
new Chara(246, "イニ義893", 133),
new Chara(247, "レア岡", 134),
new Chara(248, "UDKリンガーダ", 140),
new Chara(249, "RGLちゃん", 253),
new Chara(250, "助手のUDNGちゃん", 254),
new Chara(251, "蓬莱外科医EIRN先生", 255),
new Chara(252, "前座おじさん", 201),
new Chara(253, "どん欲な毒ALC", 202),
new Chara(254, "ハチと化した現場監督", 203),
new Chara(255, "湯呑と化したRIM", 204),
new Chara(256, "エクゾディア先輩", 205),
new Chara(257, "MUR肉", 135),
new Chara(258, "JGN", 256),
new Chara(259, "ALC市長", 257),
new Chara(260, "ALC大佐", 258),
new Chara(261, "石ALC", 259),
new Chara(262, "ヤンデRU", 260),
new Chara(263, "ホワイトチョコ先輩", 261)
];
...
new Difficulty(52, "さくらんぼ小学校(EAS)", false, [new Enemy(Chara.all[9], 1.0), new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[21], 1.0), new Enemy(Chara.all[23], 1.0), new Enemy(Chara.all[27], 1.0), new Enemy(Chara.all[7], 1.0), new Enemy(Chara.all[7], 1.0), new Enemy(Chara.all[23], 1.0), new Enemy(Chara.all[33], 1.0), new Enemy(Chara.all[67], 1.0), new Enemy(Chara.all[28], 1.0), new Enemy(Chara.all[23], 1.0), new Enemy(Chara.all[35], 1.0), new Enemy(Chara.all[43], 1.0), new Enemy(Chara.all[41], 1.0), new Enemy(Chara.all[23], 1.0), new Enemy(Chara.all[69], 0.51), new Enemy(Chara.all[26], 1.0), new Enemy(Chara.all[40], 1.0), new Enemy(Chara.all[70], 0.51), new Enemy(Chara.all[23], 1.0)]),
new Difficulty(53, "さくらんぼ小学校(ADV)", false, [new Enemy(Chara.all[9], 1.0), new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[21], 1.0), new Enemy(Chara.all[23], 1.0), new Enemy(Chara.all[10], 1.0), new Enemy(Chara.all[39], 1.0), new Enemy(Chara.all[17], 1.0), new Enemy(Chara.all[23], 1.0), new Enemy(Chara.all[27], 1.0), new Enemy(Chara.all[7], 1.0), new Enemy(Chara.all[7], 1.0), new Enemy(Chara.all[23], 1.0), new Enemy(Chara.all[33], 1.0), new Enemy(Chara.all[67], 1.0), new Enemy(Chara.all[28], 1.0), new Enemy(Chara.all[23], 1.0), new Enemy(Chara.all[35], 1.0), new Enemy(Chara.all[43], 1.0), new Enemy(Chara.all[41], 1.0), new Enemy(Chara.all[23], 1.0), new Enemy(Chara.all[69], 0.71), new Enemy(Chara.all[37], 1.0), new Enemy(Chara.all[31], 1.0), new Enemy(Chara.all[70], 0.51), new Enemy(Chara.all[23], 1.0)]),
new Difficulty(54, "さくらんぼ小学校(EXH)", false, [new Enemy(Chara.all[9], 1.0), new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[21], 1.0), new Enemy(Chara.all[23], 1.0), new Enemy(Chara.all[10], 1.0), new Enemy(Chara.all[39], 1.0), new Enemy(Chara.all[17], 1.0), new Enemy(Chara.all[23], 1.0), new Enemy(Chara.all[27], 1.0), new Enemy(Chara.all[7], 1.0), new Enemy(Chara.all[7], 1.0), new Enemy(Chara.all[23], 1.0), new Enemy(Chara.all[33], 1.0), new Enemy(Chara.all[67], 1.0), new Enemy(Chara.all[28], 1.0), new Enemy(Chara.all[23], 1.0), new Enemy(Chara.all[35], 1.0), new Enemy(Chara.all[43], 1.0), new Enemy(Chara.all[41], 1.0), new Enemy(Chara.all[23], 1.0), new Enemy(Chara.all[68], 1.0), new Enemy(Chara.all[30], 1.0), new Enemy(Chara.all[29], 1.0), new Enemy(Chara.all[23], 1.0), new Enemy(Chara.all[70], 1.0), new Enemy(Chara.all[69], 1.0), new Enemy(Chara.all[29], 1.0), new Enemy(Chara.all[30], 1.0), new Enemy(Chara.all[71], 1.0), new Enemy(Chara.all[68], 1.0)]),
new Difficulty(55, "秘密結社メガデス(EAS)", false, [new Enemy(Chara.all[27], 1.0), new Enemy(Chara.all[26], 1.0), new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[14], 1.0), new Enemy(Chara.all[72], 0.51), new Enemy(Chara.all[67], 0.51), new Enemy(Chara.all[7], 1.0), new Enemy(Chara.all[41], 1.0), new Enemy(Chara.all[72], 0.51), new Enemy(Chara.all[17], 1.0), new Enemy(Chara.all[28], 1.0), new Enemy(Chara.all[3], 1.0), new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[9], 1.0), new Enemy(Chara.all[70], 1.0), new Enemy(Chara.all[8], 1.0), new Enemy(Chara.all[74], 1.0), new Enemy(Chara.all[72], 1.0), new Enemy(Chara.all[72], 0.51), new Enemy(Chara.all[73], 0.51), new Enemy(Chara.all[73], 0.51)]),
new Difficulty(56, "秘密結社メガデス(ADV)", false, [new Enemy(Chara.all[27], 1.0), new Enemy(Chara.all[26], 1.0), new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[14], 1.0), new Enemy(Chara.all[72], 0.51), new Enemy(Chara.all[67], 0.51), new Enemy(Chara.all[7], 1.0), new Enemy(Chara.all[41], 1.0), new Enemy(Chara.all[72], 0.51), new Enemy(Chara.all[17], 1.0), new Enemy(Chara.all[28], 1.0), new Enemy(Chara.all[3], 1.0), new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[9], 1.0), new Enemy(Chara.all[70], 1.0), new Enemy(Chara.all[8], 1.0), new Enemy(Chara.all[74], 0.0), new Enemy(Chara.all[72], 1.0), new Enemy(Chara.all[72], 0.51), new Enemy(Chara.all[73], 0.51), new Enemy(Chara.all[73], 0.51), new Enemy(Chara.all[75], 0.51), new Enemy(Chara.all[72], 1.0), new Enemy(Chara.all[72], 0.51), new Enemy(Chara.all[73], 0.51), new Enemy(Chara.all[73], 0.51)]),
new Difficulty(57, "秘密結社メガデス(EXH)", false, [new Enemy(Chara.all[72], 0.51), new Enemy(Chara.all[41], 0.51), new Enemy(Chara.all[7], 1.0), new Enemy(Chara.all[67], 1.0), new Enemy(Chara.all[37], 0.51), new Enemy(Chara.all[14], 1.0), new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[69], 1.0), new Enemy(Chara.all[72], 1.0), new Enemy(Chara.all[71], 1.0), new Enemy(Chara.all[42], 1.0), new Enemy(Chara.all[73], 1.0), new Enemy(Chara.all[70], 1.0), new Enemy(Chara.all[26], 1.0), new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[37], 1.0), new Enemy(Chara.all[28], 1.0), new Enemy(Chara.all[17], 1.0), new Enemy(Chara.all[3], 1.0), new Enemy(Chara.all[72], 1.0), new Enemy(Chara.all[74], 1.0), new Enemy(Chara.all[41], 1.0), new Enemy(Chara.all[33], 1.0), new Enemy(Chara.all[4], 1.0), new Enemy(Chara.all[72], 0.51), new Enemy(Chara.all[41], 0.51), new Enemy(Chara.all[7], 1.0), new Enemy(Chara.all[67], 1.0), new Enemy(Chara.all[37], 0.51), new Enemy(Chara.all[14], 1.0), new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[69], 1.0), new Enemy(Chara.all[72], 1.0), new Enemy(Chara.all[71], 1.0), new Enemy(Chara.all[42], 1.0), new Enemy(Chara.all[73], 1.0), new Enemy(Chara.all[75], 0.51), new Enemy(Chara.all[72], 1.0), new Enemy(Chara.all[67], 1.0), new Enemy(Chara.all[72], 1.0), new Enemy(Chara.all[35], 0.51)]),
new Difficulty(58, "聖バビロン大学病院(EAS)", false, [new Enemy(Chara.all[19], 1.0), new Enemy(Chara.all[25], 1.0), new Enemy(Chara.all[20], 1.0), new Enemy(Chara.all[28], 1.0), new Enemy(Chara.all[40], 1.0), new Enemy(Chara.all[25], 0.51), new Enemy(Chara.all[30], 1.0), new Enemy(Chara.all[68], 1.0), new Enemy(Chara.all[83], 0.31), new Enemy(Chara.all[25], 1.0), new Enemy(Chara.all[43], 1.0), new Enemy(Chara.all[20], 1.0), new Enemy(Chara.all[87], 0.31), new Enemy(Chara.all[25], 1.0), new Enemy(Chara.all[70], 1.0), new Enemy(Chara.all[39], 1.0), new Enemy(Chara.all[88], 0.31), new Enemy(Chara.all[25], 1.0), new Enemy(Chara.all[83], 0.31), new Enemy(Chara.all[69], 0.51), new Enemy(Chara.all[18], 0.51)]),
new Difficulty(59, "聖バビロン大学病院(ADV)", false, [new Enemy(Chara.all[19], 1.0), new Enemy(Chara.all[25], 1.0), new Enemy(Chara.all[20], 1.0), new Enemy(Chara.all[28], 1.0), new Enemy(Chara.all[84], 1.0), new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[21], 0.51), new Enemy(Chara.all[20], 1.0), new Enemy(Chara.all[25], 1.0), new Enemy(Chara.all[17], 1.0), new Enemy(Chara.all[28], 0.51), new Enemy(Chara.all[85], 1.0), new Enemy(Chara.all[24], 1.0), new Enemy(Chara.all[83], 0.31), new Enemy(Chara.all[25], 1.0), new Enemy(Chara.all[43], 1.0), new Enemy(Chara.all[20], 1.0), new Enemy(Chara.all[37], 0.31), new Enemy(Chara.all[25], 1.0), new Enemy(Chara.all[30], 1.0), new Enemy(Chara.all[29], 1.0), new Enemy(Chara.all[87], 0.31), new Enemy(Chara.all[86], 1.0), new Enemy(Chara.all[70], 1.0), new Enemy(Chara.all[39], 1.0), new Enemy(Chara.all[88], 0.31), new Enemy(Chara.all[25], 1.0), new Enemy(Chara.all[83], 0.31), new Enemy(Chara.all[69], 0.51), new Enemy(Chara.all[67], 0.51)]),
new Difficulty(60, "聖バビロン大学病院(EXH)", false, [new Enemy(Chara.all[19], 1.0), new Enemy(Chara.all[25], 1.0), new Enemy(Chara.all[20], 1.0), new Enemy(Chara.all[28], 1.0), new Enemy(Chara.all[84], 1.0), new Enemy(Chara.all[12], 1.0), new Enemy(Chara.all[7], 1.0), new Enemy(Chara.all[3], 1.0), new Enemy(Chara.all[28], 1.0), new Enemy(Chara.all[84], 1.0), new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[21], 0.51), new Enemy(Chara.all[39], 1.0), new Enemy(Chara.all[25], 1.0), new Enemy(Chara.all[17], 1.0), new Enemy(Chara.all[28], 0.51), new Enemy(Chara.all[85], 1.0), new Enemy(Chara.all[10], 1.0), new Enemy(Chara.all[24], 1.0), new Enemy(Chara.all[83], 0.31), new Enemy(Chara.all[25], 1.0), new Enemy(Chara.all[69], 1.0), new Enemy(Chara.all[9], 1.0), new Enemy(Chara.all[68], 0.31), new Enemy(Chara.all[25], 1.0), new Enemy(Chara.all[30], 1.0), new Enemy(Chara.all[29], 1.0), new Enemy(Chara.all[87], 0.31), new Enemy(Chara.all[86], 1.0), new Enemy(Chara.all[70], 1.0), new Enemy(Chara.all[39], 1.0), new Enemy(Chara.all[15], 0.31), new Enemy(Chara.all[28], 1.0), new Enemy(Chara.all[85], 1.0), new Enemy(Chara.all[14], 1.0), new Enemy(Chara.all[10], 1.0), new Enemy(Chara.all[89], 0.31), new Enemy(Chara.all[71], 1.0), new Enemy(Chara.all[88], 0.31), new Enemy(Chara.all[67], 0.51)]),
new Difficulty(61, "赤城不動産(EAS)", false, [new Enemy(Chara.all[19], 1.0), new Enemy(Chara.all[70], 1.0), new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[6], 1.0), new Enemy(Chara.all[15], 1.0), new Enemy(Chara.all[41], 0.51), new Enemy(Chara.all[4], 1.0), new Enemy(Chara.all[36], 1.0), new Enemy(Chara.all[92], 0.31), new Enemy(Chara.all[3], 1.0), new Enemy(Chara.all[17], 1.0), new Enemy(Chara.all[38], 1.0), new Enemy(Chara.all[44], 1.0), new Enemy(Chara.all[43], 1.0), new Enemy(Chara.all[9], 1.0), new Enemy(Chara.all[83], 1.0), new Enemy(Chara.all[94], 0.31), new Enemy(Chara.all[21], 1.0), new Enemy(Chara.all[39], 0.31), new Enemy(Chara.all[69], 0.51)]),
new Difficulty(62, "赤城不動産(ADV)", false, [new Enemy(Chara.all[68], 1.0), new Enemy(Chara.all[30], 1.0), new Enemy(Chara.all[29], 1.0), new Enemy(Chara.all[87], 1.0), new Enemy(Chara.all[69], 1.0), new Enemy(Chara.all[92], 1.0), new Enemy(Chara.all[37], 0.51), new Enemy(Chara.all[24], 1.0), new Enemy(Chara.all[28], 1.0), new Enemy(Chara.all[5], 1.0), new Enemy(Chara.all[6], 0.51), new Enemy(Chara.all[32], 1.0), new Enemy(Chara.all[33], 1.0), new Enemy(Chara.all[34], 1.0), new Enemy(Chara.all[35], 0.31), new Enemy(Chara.all[34], 1.0), new Enemy(Chara.all[24], 1.0), new Enemy(Chara.all[41], 1.0), new Enemy(Chara.all[84], 1.0), new Enemy(Chara.all[93], 0.51), new Enemy(Chara.all[42], 1.0), new Enemy(Chara.all[38], 1.0), new Enemy(Chara.all[83], 1.0), new Enemy(Chara.all[18], 0.31), new Enemy(Chara.all[20], 1.0), new Enemy(Chara.all[21], 1.0), new Enemy(Chara.all[39], 1.0), new Enemy(Chara.all[94], 0.51), new Enemy(Chara.all[36], 1.0), new Enemy(Chara.all[88], 0.31), new Enemy(Chara.all[69], 0.51), new Enemy(Chara.all[67], 0.51)]),
new Difficulty(63, "赤城不動産(EXH)", false, [new Enemy(Chara.all[68], 1.0), new Enemy(Chara.all[30], 1.0), new Enemy(Chara.all[29], 1.0), new Enemy(Chara.all[87], 1.0), new Enemy(Chara.all[69], 1.0), new Enemy(Chara.all[39], 1.0), new Enemy(Chara.all[10], 1.0), new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[68], 1.0), new Enemy(Chara.all[70], 1.0), new Enemy(Chara.all[92], 1.0), new Enemy(Chara.all[37], 0.51), new Enemy(Chara.all[24], 1.0), new Enemy(Chara.all[28], 1.0), new Enemy(Chara.all[5], 1.0), new Enemy(Chara.all[6], 0.51), new Enemy(Chara.all[32], 1.0), new Enemy(Chara.all[33], 1.0), new Enemy(Chara.all[34], 1.0), new Enemy(Chara.all[35], 0.31), new Enemy(Chara.all[34], 1.0), new Enemy(Chara.all[24], 1.0), new Enemy(Chara.all[41], 1.0), new Enemy(Chara.all[84], 1.0), new Enemy(Chara.all[93], 0.51), new Enemy(Chara.all[42], 1.0), new Enemy(Chara.all[89], 1.0), new Enemy(Chara.all[71], 1.0), new Enemy(Chara.all[44], 0.51), new Enemy(Chara.all[43], 1.0), new Enemy(Chara.all[11], 1.0), new Enemy(Chara.all[36], 1.0), new Enemy(Chara.all[73], 0.51), new Enemy(Chara.all[72], 1.0), new Enemy(Chara.all[72], 1.0), new Enemy(Chara.all[72], 1.0), new Enemy(Chara.all[35], 1.0), new Enemy(Chara.all[18], 0.31), new Enemy(Chara.all[20], 1.0), new Enemy(Chara.all[21], 1.0), new Enemy(Chara.all[39], 1.0), new Enemy(Chara.all[94], 1.0), new Enemy(Chara.all[95], 0.51), new Enemy(Chara.all[88], 0.31), new Enemy(Chara.all[13], 0.0), new Enemy(Chara.all[67], 0.51)]),
new Difficulty(64, "よっちゃんイカ工場(EAS)", false, [new Enemy(Chara.all[5], 1.0), new Enemy(Chara.all[6], 1.0), new Enemy(Chara.all[24], 1.0), new Enemy(Chara.all[84], 1.0), new Enemy(Chara.all[21], 1.0), new Enemy(Chara.all[20], 0.51), new Enemy(Chara.all[4], 1.0), new Enemy(Chara.all[19], 1.0), new Enemy(Chara.all[101], 0.31), new Enemy(Chara.all[41], 1.0), new Enemy(Chara.all[36], 1.0), new Enemy(Chara.all[74], 1.0), new Enemy(Chara.all[70], 1.0), new Enemy(Chara.all[67], 1.0), new Enemy(Chara.all[26], 1.0), new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[102], 0.31), new Enemy(Chara.all[41], 1.0), new Enemy(Chara.all[36], 1.0), new Enemy(Chara.all[74], 1.0), new Enemy(Chara.all[17], 0.31), new Enemy(Chara.all[38], 1.0), new Enemy(Chara.all[28], 1.0), new Enemy(Chara.all[3], 1.0), new Enemy(Chara.all[83], 1.0), new Enemy(Chara.all[88], 1.0), new Enemy(Chara.all[86], 1.0), new Enemy(Chara.all[9], 1.0), new Enemy(Chara.all[107], 0.31), new Enemy(Chara.all[29], 1.0), new Enemy(Chara.all[39], 0.31), new Enemy(Chara.all[69], 0.51), new Enemy(Chara.all[30], 0.51)]),
...
new Difficulty(66, "よっちゃんイカ工場(EXH)", false, [new Enemy(Chara.all[5], 1.0), new Enemy(Chara.all[6], 1.0), new Enemy(Chara.all[24], 1.0), new Enemy(Chara.all[84], 1.0), new Enemy(Chara.all[14], 1.0), new Enemy(Chara.all[31], 0.51), new Enemy(Chara.all[70], 1.0), new Enemy(Chara.all[19], 1.0), new Enemy(Chara.all[101], 0.51), new Enemy(Chara.all[41], 1.0), new Enemy(Chara.all[36], 1.0), new Enemy(Chara.all[74], 1.0), new Enemy(Chara.all[21], 1.0), new Enemy(Chara.all[20], 1.0), new Enemy(Chara.all[26], 1.0), new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[17], 1.0), new Enemy(Chara.all[72], 1.0), new Enemy(Chara.all[72], 1.0), new Enemy(Chara.all[35], 1.0), new Enemy(Chara.all[102], 0.51), new Enemy(Chara.all[41], 1.0), new Enemy(Chara.all[36], 1.0), new Enemy(Chara.all[75], 1.0), new Enemy(Chara.all[29], 1.0), new Enemy(Chara.all[17], 1.0), new Enemy(Chara.all[38], 1.0), new Enemy(Chara.all[28], 1.0), new Enemy(Chara.all[3], 1.0), new Enemy(Chara.all[83], 1.0), new Enemy(Chara.all[88], 1.0), new Enemy(Chara.all[86], 1.0), new Enemy(Chara.all[9], 1.0), new Enemy(Chara.all[103], 0.51), new Enemy(Chara.all[84], 1.0), new Enemy(Chara.all[36], 1.0), new Enemy(Chara.all[21], 1.0), new Enemy(Chara.all[95], 1.0), new Enemy(Chara.all[11], 1.0), new Enemy(Chara.all[38], 1.0), new Enemy(Chara.all[41], 1.0), new Enemy(Chara.all[104], 0.31), new Enemy(Chara.all[15], 1.0), new Enemy(Chara.all[28], 1.0), new Enemy(Chara.all[16], 1.0), new Enemy(Chara.all[69], 1.0), new Enemy(Chara.all[107], 0.51), new Enemy(Chara.all[29], 1.0), new Enemy(Chara.all[42], 0.31), new Enemy(Chara.all[69], 0.51), new Enemy(Chara.all[30], 0.51)]),
...
new Difficulty(120, "人間の里のゲーム屋(EAS)", true, [new Enemy(Chara.all[157], 1.0), new Enemy(Chara.all[104], 1.0), new Enemy(Chara.all[54], 1.0), new Enemy(Chara.all[102], 1.0), new Enemy(Chara.all[13], 1.0), new Enemy(Chara.all[52], 1.0), new Enemy(Chara.all[101], 1.0), new Enemy(Chara.all[128], 1.0), new Enemy(Chara.all[53], 1.0), new Enemy(Chara.all[103], 1.0), new Enemy(Chara.all[126], 1.0), new Enemy(Chara.all[127], 1.0), new Enemy(Chara.all[175], 0.31), new Enemy(Chara.all[10], 0.31), new Enemy(Chara.all[90], 0.31)]),
new Difficulty(121, "人間の里のゲーム屋(ADV)", true, [new Enemy(Chara.all[39], 1.0), new Enemy(Chara.all[21], 1.0), new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[20], 1.0), new Enemy(Chara.all[157], 1.0), new Enemy(Chara.all[104], 1.0), new Enemy(Chara.all[54], 1.0), new Enemy(Chara.all[42], 1.0), new Enemy(Chara.all[102], 1.0), new Enemy(Chara.all[13], 1.0), new Enemy(Chara.all[52], 1.0), new Enemy(Chara.all[88], 1.0), new Enemy(Chara.all[105], 1.0), new Enemy(Chara.all[8], 1.0), new Enemy(Chara.all[7], 1.0), new Enemy(Chara.all[127], 1.0), new Enemy(Chara.all[101], 1.0), new Enemy(Chara.all[128], 1.0), new Enemy(Chara.all[53], 1.0), new Enemy(Chara.all[95], 1.0), new Enemy(Chara.all[103], 1.0), new Enemy(Chara.all[126], 1.0), new Enemy(Chara.all[16], 1.0), new Enemy(Chara.all[147], 1.0), new Enemy(Chara.all[175], 0.51), new Enemy(Chara.all[40], 0.31), new Enemy(Chara.all[90], 0.31), new Enemy(Chara.all[35], 0.31), new Enemy(Chara.all[90], 0.31)]),
new Difficulty(122, "人間の里のゲーム屋(EXH)", true, [new Enemy(Chara.all[21], 1.0), new Enemy(Chara.all[39], 1.0), new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[20], 1.0), new Enemy(Chara.all[105], 1.0), new Enemy(Chara.all[8], 1.0), new Enemy(Chara.all[51], 1.0), new Enemy(Chara.all[127], 1.0), new Enemy(Chara.all[89], 1.0), new Enemy(Chara.all[88], 1.0), new Enemy(Chara.all[126], 1.0), new Enemy(Chara.all[52], 1.0), new Enemy(Chara.all[159], 1.0), new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[67], 1.0), new Enemy(Chara.all[19], 1.0), new Enemy(Chara.all[154], 1.0), new Enemy(Chara.all[54], 1.0), new Enemy(Chara.all[157], 1.0), new Enemy(Chara.all[128], 1.0), new Enemy(Chara.all[169], 1.0), new Enemy(Chara.all[22], 1.0), new Enemy(Chara.all[74], 1.0), new Enemy(Chara.all[75], 1.0), new Enemy(Chara.all[59], 1.0), new Enemy(Chara.all[147], 1.0), new Enemy(Chara.all[27], 1.0), new Enemy(Chara.all[7], 1.0), new Enemy(Chara.all[60], 1.0), new Enemy(Chara.all[35], 1.0), new Enemy(Chara.all[72], 1.0), new Enemy(Chara.all[41], 1.0), new Enemy(Chara.all[111], 1.0), new Enemy(Chara.all[44], 1.0), new Enemy(Chara.all[43], 1.0), new Enemy(Chara.all[11], 1.0), new Enemy(Chara.all[176], 1.0), new Enemy(Chara.all[175], 0.31), new Enemy(Chara.all[90], 0.31), new Enemy(Chara.all[40], 0.31)]),
new Difficulty(123, "まりスト例大祭(EAS)", true, [new Enemy(Chara.all[102], 1.0), new Enemy(Chara.all[101], 1.0), new Enemy(Chara.all[103], 1.0), new Enemy(Chara.all[62], 1.0), new Enemy(Chara.all[63], 1.0), new Enemy(Chara.all[64], 1.0), new Enemy(Chara.all[180], 0.31), new Enemy(Chara.all[52], 0.31), new Enemy(Chara.all[53], 0.31), new Enemy(Chara.all[54], 0.31)]),
new Difficulty(124, "まりスト例大祭(ADV)", true, [new Enemy(Chara.all[76], 1.0), new Enemy(Chara.all[77], 1.0), new Enemy(Chara.all[78], 1.0), new Enemy(Chara.all[57], 1.0), new Enemy(Chara.all[58], 1.0), new Enemy(Chara.all[59], 1.0), new Enemy(Chara.all[52], 1.0), new Enemy(Chara.all[53], 1.0), new Enemy(Chara.all[54], 1.0), new Enemy(Chara.all[126], 1.0), new Enemy(Chara.all[127], 1.0), new Enemy(Chara.all[128], 1.0), new Enemy(Chara.all[180], 0.51), new Enemy(Chara.all[79], 1.0), new Enemy(Chara.all[81], 1.0), new Enemy(Chara.all[80], 1.0)]),
new Difficulty(125, "まりスト例大祭(EXH)", true, [new Enemy(Chara.all[60], 1.0), new Enemy(Chara.all[88], 1.0), new Enemy(Chara.all[78], 1.0), new Enemy(Chara.all[76], 1.0), new Enemy(Chara.all[77], 1.0), new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[26], 1.0), new Enemy(Chara.all[27], 1.0), new Enemy(Chara.all[137], 1.0), new Enemy(Chara.all[140], 1.0), new Enemy(Chara.all[16], 1.0), new Enemy(Chara.all[15], 1.0), new Enemy(Chara.all[139], 1.0), new Enemy(Chara.all[138], 1.0), new Enemy(Chara.all[5], 1.0), new Enemy(Chara.all[6], 1.0), new Enemy(Chara.all[141], 1.0), new Enemy(Chara.all[142], 1.0), new Enemy(Chara.all[13], 1.0), new Enemy(Chara.all[106], 1.0), new Enemy(Chara.all[65], 1.0), new Enemy(Chara.all[62], 1.0), new Enemy(Chara.all[63], 1.0), new Enemy(Chara.all[64], 1.0), new Enemy(Chara.all[180], 1.0), new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[19], 1.0), new Enemy(Chara.all[79], 1.0)]),
new Difficulty(126, "まりスト例大祭(LEG)", true, [new Enemy(Chara.all[18], 0.0), new Enemy(Chara.all[19], 0.0), new Enemy(Chara.all[127], 0.0), new Enemy(Chara.all[76], 0.02), new Enemy(Chara.all[79], 0.0), new Enemy(Chara.all[141], 0.0), new Enemy(Chara.all[140], 0.0), new Enemy(Chara.all[77], 0.0), new Enemy(Chara.all[136], 0.0), new Enemy(Chara.all[31], 0.0), new Enemy(Chara.all[82], 0.0), new Enemy(Chara.all[35], 0.0), new Enemy(Chara.all[72], 0.0), new Enemy(Chara.all[65], 0.0), new Enemy(Chara.all[158], 0.0), new Enemy(Chara.all[7], 0.0), new Enemy(Chara.all[53], 0.0), new Enemy(Chara.all[59], 0.0), new Enemy(Chara.all[27], 0.0), new Enemy(Chara.all[7], 0.0), new Enemy(Chara.all[147], 0.0), new Enemy(Chara.all[143], 0.0), new Enemy(Chara.all[175], 0.0), new Enemy(Chara.all[142], 0.0), new Enemy(Chara.all[126], 0.0), new Enemy(Chara.all[153], 0.0), new Enemy(Chara.all[57], 0.0), new Enemy(Chara.all[58], 0.0), new Enemy(Chara.all[104], 0.0), new Enemy(Chara.all[81], 0.0), new Enemy(Chara.all[128], 0.0), new Enemy(Chara.all[51], 0.0), new Enemy(Chara.all[4], 0.0), new Enemy(Chara.all[137], 0.0), new Enemy(Chara.all[180], 1.0), new Enemy(Chara.all[17], 0.0), new Enemy(Chara.all[54], 0.0), new Enemy(Chara.all[95], 0.0), new Enemy(Chara.all[40], 0.0), new Enemy(Chara.all[181], 1.0), new Enemy(Chara.all[0], 0.0), new Enemy(Chara.all[1], 0.0), new Enemy(Chara.all[2], 0.0), new Enemy(Chara.all[9], 0.0)]),
new Difficulty(127, "三銃士乱入フェス(チャリオット平野戦)", true, [new Enemy(Chara.all[182], 1.0), new Enemy(Chara.all[68], 0.0), new Enemy(Chara.all[30], 0.0), new Enemy(Chara.all[127], 0.0), new Enemy(Chara.all[167], 0.0)]),
new Difficulty(128, "三銃士乱入フェス(剣聖おじさん戦)", true, [new Enemy(Chara.all[183], 1.0), new Enemy(Chara.all[104], 0.0), new Enemy(Chara.all[86], 0.0), new Enemy(Chara.all[57], 0.0), new Enemy(Chara.all[16], 0.0)]),
new Difficulty(129, "三銃士乱入フェス(破面KBTIT戦)", true, [new Enemy(Chara.all[184], 1.0), new Enemy(Chara.all[147], 0.0), new Enemy(Chara.all[7], 0.0), new Enemy(Chara.all[27], 0.0), new Enemy(Chara.all[158], 0.0)]),
new Difficulty(130, "三銃士乱入フェス(AKMRくん戦)", true, [new Enemy(Chara.all[185], 1.0), new Enemy(Chara.all[183], 1.0), new Enemy(Chara.all[184], 0.0), new Enemy(Chara.all[182], 0.0), new Enemy(Chara.all[23], 0.0)]),
new Difficulty(131, "釣リスマスおばさん乱入フェス(釣リスマスおばさん戦)", true, [new Enemy(Chara.all[204], 1.0), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[90], 1.0)]),
new Difficulty(132, "命蓮寺(EAS)", true, [new Enemy(Chara.all[52], 0.31), new Enemy(Chara.all[127], 0.51), new Enemy(Chara.all[142], 0.51), new Enemy(Chara.all[208], 0.31), new Enemy(Chara.all[196], 0.51), new Enemy(Chara.all[126], 0.51), new Enemy(Chara.all[79], 0.31), new Enemy(Chara.all[51], 0.51), new Enemy(Chara.all[128], 0.31), new Enemy(Chara.all[207], 0.31), new Enemy(Chara.all[204], 0.31), new Enemy(Chara.all[78], 0.31)]),
new Difficulty(133, "命蓮寺(ADV)", true, [new Enemy(Chara.all[207], 0.51), new Enemy(Chara.all[3], 0.51), new Enemy(Chara.all[57], 0.51), new Enemy(Chara.all[104], 0.51), new Enemy(Chara.all[78], 0.51), new Enemy(Chara.all[186], 0.31), new Enemy(Chara.all[9], 0.51), new Enemy(Chara.all[76], 0.51), new Enemy(Chara.all[159], 0.51), new Enemy(Chara.all[208], 0.51), new Enemy(Chara.all[28], 0.51), new Enemy(Chara.all[84], 0.51), new Enemy(Chara.all[5], 0.51), new Enemy(Chara.all[6], 0.51), new Enemy(Chara.all[79], 0.31), new Enemy(Chara.all[67], 0.51), new Enemy(Chara.all[53], 0.31), new Enemy(Chara.all[138], 0.31), new Enemy(Chara.all[42], 0.31), new Enemy(Chara.all[209], 0.31), new Enemy(Chara.all[54], 0.31), new Enemy(Chara.all[77], 0.31), new Enemy(Chara.all[27], 0.31), new Enemy(Chara.all[26], 0.31), new Enemy(Chara.all[102], 0.31), new Enemy(Chara.all[101], 0.31), new Enemy(Chara.all[171], 0.31), new Enemy(Chara.all[140], 0.31), new Enemy(Chara.all[142], 0.31), new Enemy(Chara.all[210], 0.31), new Enemy(Chara.all[103], 0.31), new Enemy(Chara.all[18], 0.31), new Enemy(Chara.all[19], 0.31)]),
new Difficulty(134, "命蓮寺(EXH)", true, [new Enemy(Chara.all[207], 0.31), new Enemy(Chara.all[28], 0.51), new Enemy(Chara.all[57], 0.51), new Enemy(Chara.all[104], 0.51), new Enemy(Chara.all[153], 0.51), new Enemy(Chara.all[186], 0.31), new Enemy(Chara.all[18], 0.51), new Enemy(Chara.all[76], 0.51), new Enemy(Chara.all[159], 0.51), new Enemy(Chara.all[208], 0.31), new Enemy(Chara.all[35], 0.51), new Enemy(Chara.all[32], 0.51), new Enemy(Chara.all[33], 0.51), new Enemy(Chara.all[34], 0.51), new Enemy(Chara.all[79], 0.31), new Enemy(Chara.all[67], 0.51), new Enemy(Chara.all[41], 0.31), new Enemy(Chara.all[157], 0.31), new Enemy(Chara.all[42], 0.31), new Enemy(Chara.all[209], 0.51), new Enemy(Chara.all[54], 0.31), new Enemy(Chara.all[77], 0.31), new Enemy(Chara.all[193], 0.31), new Enemy(Chara.all[67], 0.31), new Enemy(Chara.all[105], 0.31), new Enemy(Chara.all[8], 0.31), new Enemy(Chara.all[7], 0.31), new Enemy(Chara.all[81], 0.31), new Enemy(Chara.all[210], 0.51), new Enemy(Chara.all[140], 0.31), new Enemy(Chara.all[68], 0.31), new Enemy(Chara.all[167], 0.31), new Enemy(Chara.all[167], 0.31), new Enemy(Chara.all[109], 0.31), new Enemy(Chara.all[191], 0.51), new Enemy(Chara.all[180], 0.51), new Enemy(Chara.all[196], 0.51), new Enemy(Chara.all[211], 0.31), new Enemy(Chara.all[207], 0.31), new Enemy(Chara.all[208], 0.31), new Enemy(Chara.all[35], 0.31), new Enemy(Chara.all[41], 0.31)]),
new Difficulty(135, "命蓮寺(LEG)", true, [new Enemy(Chara.all[109], 0.31), new Enemy(Chara.all[191], 0.51), new Enemy(Chara.all[180], 0.51), new Enemy(Chara.all[17], 0.51), new Enemy(Chara.all[207], 1.0), new Enemy(Chara.all[67], 0.51), new Enemy(Chara.all[57], 0.51), new Enemy(Chara.all[28], 0.51), new Enemy(Chara.all[153], 0.51), new Enemy(Chara.all[44], 0.31), new Enemy(Chara.all[52], 0.51), new Enemy(Chara.all[39], 0.51), new Enemy(Chara.all[195], 0.51), new Enemy(Chara.all[67], 0.51), new Enemy(Chara.all[208], 1.0), new Enemy(Chara.all[35], 0.51), new Enemy(Chara.all[41], 0.51), new Enemy(Chara.all[78], 0.51), new Enemy(Chara.all[54], 0.51), new Enemy(Chara.all[206], 0.31), new Enemy(Chara.all[81], 0.51), new Enemy(Chara.all[205], 0.31), new Enemy(Chara.all[21], 0.31), new Enemy(Chara.all[209], 1.0), new Enemy(Chara.all[54], 0.31), new Enemy(Chara.all[77], 0.31), new Enemy(Chara.all[70], 0.31), new Enemy(Chara.all[67], 0.31), new Enemy(Chara.all[105], 0.31), new Enemy(Chara.all[8], 0.31), new Enemy(Chara.all[7], 0.31), new Enemy(Chara.all[81], 0.31), new Enemy(Chara.all[210], 1.0), new Enemy(Chara.all[140], 0.31), new Enemy(Chara.all[142], 0.31), new Enemy(Chara.all[93], 0.31), new Enemy(Chara.all[36], 0.31), new Enemy(Chara.all[107], 0.51), new Enemy(Chara.all[53], 0.31), new Enemy(Chara.all[94], 0.31), new Enemy(Chara.all[29], 0.31), new Enemy(Chara.all[69], 0.31), new Enemy(Chara.all[211], 1.0), new Enemy(Chara.all[207], 0.31), new Enemy(Chara.all[35], 0.31), new Enemy(Chara.all[36], 0.31), new Enemy(Chara.all[157], 0.31), new Enemy(Chara.all[88], 0.31), new Enemy(Chara.all[140], 0.31), new Enemy(Chara.all[88], 0.31), new Enemy(Chara.all[88], 0.31), new Enemy(Chara.all[88], 0.31), new Enemy(Chara.all[212], 1.0), new Enemy(Chara.all[207], 0.0), new Enemy(Chara.all[211], 0.0), new Enemy(Chara.all[209], 0.0), new Enemy(Chara.all[213], 1.0), new Enemy(Chara.all[212], 0.51), new Enemy(Chara.all[22], 0.0), new Enemy(Chara.all[79], 0.0)]),
new Difficulty(136, "博麗神社節分の日！(EAS)", true, [new Enemy(Chara.all[102], 0.31), new Enemy(Chara.all[103], 0.51), new Enemy(Chara.all[101], 0.51), new Enemy(Chara.all[62], 0.31), new Enemy(Chara.all[63], 0.51), new Enemy(Chara.all[64], 0.51), new Enemy(Chara.all[233], 0.11), new Enemy(Chara.all[175], 0.31), new Enemy(Chara.all[180], 0.31)]),
new Difficulty(137, "博麗神社節分の日！(ADV)", true, [new Enemy(Chara.all[176], 0.31), new Enemy(Chara.all[216], 0.51), new Enemy(Chara.all[224], 0.51), new Enemy(Chara.all[194], 0.31), new Enemy(Chara.all[175], 0.51), new Enemy(Chara.all[158], 0.51), new Enemy(Chara.all[181], 0.31), new Enemy(Chara.all[80], 0.51), new Enemy(Chara.all[78], 0.51), new Enemy(Chara.all[233], 0.51), new Enemy(Chara.all[137], 0.31), new Enemy(Chara.all[197], 0.31)]),
new Difficulty(138, "博麗神社節分の日！(EXH)", true, [new Enemy(Chara.all[196], 0.31), new Enemy(Chara.all[180], 0.51), new Enemy(Chara.all[109], 0.51), new Enemy(Chara.all[228], 0.51), new Enemy(Chara.all[176], 0.31), new Enemy(Chara.all[216], 0.51), new Enemy(Chara.all[77], 0.51), new Enemy(Chara.all[159], 0.51), new Enemy(Chara.all[194], 0.31), new Enemy(Chara.all[175], 0.51), new Enemy(Chara.all[158], 0.51), new Enemy(Chara.all[197], 0.51), new Enemy(Chara.all[181], 0.31), new Enemy(Chara.all[80], 0.51), new Enemy(Chara.all[78], 0.51), new Enemy(Chara.all[209], 0.0), new Enemy(Chara.all[7], 0.51), new Enemy(Chara.all[233], 1.0), new Enemy(Chara.all[88], 1.0), new Enemy(Chara.all[126], 1.0), new Enemy(Chara.all[60], 1.0)]),
new Difficulty(139, "節分の日乱入クエスト(淫夢之一太刀SIK戦)", true, [new Enemy(Chara.all[234], 1.0), new Enemy(Chara.all[31], 0.0), new Enemy(Chara.all[27], 0.0), new Enemy(Chara.all[157], 0.0), new Enemy(Chara.all[127], 0.0)]),
new Difficulty(140, "バレンタインの博麗神社(EAS)", true, [new Enemy(Chara.all[221], 0.31), new Enemy(Chara.all[126], 0.31), new Enemy(Chara.all[13], 0.31), new Enemy(Chara.all[195], 0.51), new Enemy(Chara.all[141], 0.51), new Enemy(Chara.all[157], 0.31), new Enemy(Chara.all[128], 0.51), new Enemy(Chara.all[238], 1.0), new Enemy(Chara.all[80], 0.31), new Enemy(Chara.all[127], 0.31)]),
new Difficulty(141, "バレンタインの博麗神社(ADV)", true, [new Enemy(Chara.all[221], 0.31), new Enemy(Chara.all[126], 0.31), new Enemy(Chara.all[106], 0.31), new Enemy(Chara.all[128], 0.51), new Enemy(Chara.all[79], 0.31), new Enemy(Chara.all[13], 0.31), new Enemy(Chara.all[195], 0.51), new Enemy(Chara.all[141], 0.51), new Enemy(Chara.all[157], 0.31), new Enemy(Chara.all[196], 0.51), new Enemy(Chara.all[105], 0.31), new Enemy(Chara.all[51], 0.51), new Enemy(Chara.all[127], 0.31), new Enemy(Chara.all[239], 1.0), new Enemy(Chara.all[142], 0.31), new Enemy(Chara.all[141], 0.31)]),
new Difficulty(142, "バレンタインの博麗神社(EXH)", true, [new Enemy(Chara.all[221], 0.31), new Enemy(Chara.all[126], 0.31), new Enemy(Chara.all[106], 0.31), new Enemy(Chara.all[128], 0.51), new Enemy(Chara.all[79], 0.31), new Enemy(Chara.all[13], 0.31), new Enemy(Chara.all[195], 0.51), new Enemy(Chara.all[141], 0.51), new Enemy(Chara.all[138], 0.31), new Enemy(Chara.all[140], 0.51), new Enemy(Chara.all[139], 0.31), new Enemy(Chara.all[157], 0.31), new Enemy(Chara.all[196], 0.51), new Enemy(Chara.all[105], 0.31), new Enemy(Chara.all[51], 0.51), new Enemy(Chara.all[127], 0.31), new Enemy(Chara.all[233], 0.31), new Enemy(Chara.all[78], 0.51), new Enemy(Chara.all[181], 0.31), new Enemy(Chara.all[240], 1.0), new Enemy(Chara.all[142], 0.31), new Enemy(Chara.all[80], 0.31)]),
new Difficulty(143, "バレンタインの博麗神社(LEG)", true, [new Enemy(Chara.all[159], 1.0), new Enemy(Chara.all[77], 0.0), new Enemy(Chara.all[54], 0.31), new Enemy(Chara.all[127], 0.31), new Enemy(Chara.all[236], 1.0), new Enemy(Chara.all[35], 0.0), new Enemy(Chara.all[95], 0.0), new Enemy(Chara.all[78], 0.31), new Enemy(Chara.all[128], 0.31), new Enemy(Chara.all[196], 1.0), new Enemy(Chara.all[109], 0.0), new Enemy(Chara.all[191], 0.0), new Enemy(Chara.all[180], 0.31), new Enemy(Chara.all[240], 1.0), new Enemy(Chara.all[239], 1.0), new Enemy(Chara.all[142], 0.31), new Enemy(Chara.all[80], 0.31), new Enemy(Chara.all[140], 0.31), new Enemy(Chara.all[206], 1.0), new Enemy(Chara.all[139], 0.31), new Enemy(Chara.all[205], 0.0), new Enemy(Chara.all[93], 0.0), new Enemy(Chara.all[137], 0.31), new Enemy(Chara.all[52], 0.31), new Enemy(Chara.all[57], 0.31), new Enemy(Chara.all[39], 0.0), new Enemy(Chara.all[173], 0.0), new Enemy(Chara.all[187], 0.31), new Enemy(Chara.all[238], 1.0), new Enemy(Chara.all[53], 0.31), new Enemy(Chara.all[95], 0.0), new Enemy(Chara.all[67], 0.0), new Enemy(Chara.all[126], 0.31), new Enemy(Chara.all[234], 1.0), new Enemy(Chara.all[38], 0.0), new Enemy(Chara.all[26], 0.0), new Enemy(Chara.all[223], 0.0), new Enemy(Chara.all[42], 0.0), new Enemy(Chara.all[88], 0.0), new Enemy(Chara.all[140], 0.31), new Enemy(Chara.all[88], 0.0), new Enemy(Chara.all[150], 0.0), new Enemy(Chara.all[88], 0.0), new Enemy(Chara.all[241], 1.0), new Enemy(Chara.all[58], 1.0), new Enemy(Chara.all[220], 0.31), new Enemy(Chara.all[79], 0.31), new Enemy(Chara.all[186], 0.31), new Enemy(Chara.all[242], 1.0), new Enemy(Chara.all[59], 0.0), new Enemy(Chara.all[241], 1.0)]),
new Difficulty(144, "半年記念祭in博麗神社(EAS)", false, [new Enemy(Chara.all[52], 0.31), new Enemy(Chara.all[53], 0.31), new Enemy(Chara.all[54], 0.31), new Enemy(Chara.all[244], 1.0)]),
new Difficulty(145, "半年記念祭in博麗神社(ADV)", false, [new Enemy(Chara.all[194], 0.31), new Enemy(Chara.all[175], 0.31), new Enemy(Chara.all[104], 0.31), new Enemy(Chara.all[220], 0.31), new Enemy(Chara.all[221], 0.31), new Enemy(Chara.all[79], 0.31), new Enemy(Chara.all[174], 0.31), new Enemy(Chara.all[95], 0.31), new Enemy(Chara.all[140], 0.31), new Enemy(Chara.all[244], 1.0)]),
new Difficulty(146, "半年記念祭in博麗神社(EXH)", false, [new Enemy(Chara.all[60], 0.31), new Enemy(Chara.all[57], 0.31), new Enemy(Chara.all[59], 0.31), new Enemy(Chara.all[82], 0.31), new Enemy(Chara.all[79], 0.31), new Enemy(Chara.all[81], 0.31), new Enemy(Chara.all[143], 0.31), new Enemy(Chara.all[141], 0.31), new Enemy(Chara.all[142], 0.31), new Enemy(Chara.all[244], 1.0)]),
new Difficulty(147, "半年記念祭in博麗神社(LEG)", false, [new Enemy(Chara.all[244], 0.0), new Enemy(Chara.all[238], 1.0), new Enemy(Chara.all[239], 1.0), new Enemy(Chara.all[142], 0.0), new Enemy(Chara.all[240], 1.0), new Enemy(Chara.all[244], 0.0), new Enemy(Chara.all[159], 0.0), new Enemy(Chara.all[140], 0.0), new Enemy(Chara.all[54], 0.0), new Enemy(Chara.all[244], 0.0), new Enemy(Chara.all[82], 0.0), new Enemy(Chara.all[104], 0.0), new Enemy(Chara.all[244], 0.0), new Enemy(Chara.all[234], 0.0), new Enemy(Chara.all[88], 0.0), new Enemy(Chara.all[83], 0.0), new Enemy(Chara.all[206], 0.0), new Enemy(Chara.all[244], 0.0), new Enemy(Chara.all[30], 0.0), new Enemy(Chara.all[167], 0.0), new Enemy(Chara.all[29], 0.0), new Enemy(Chara.all[7], 0.0), new Enemy(Chara.all[244], 0.0), new Enemy(Chara.all[244], 0.0)]),
new Difficulty(148, "感情こころ乱入クエスト(怒声の妖精面戦)", false, [new Enemy(Chara.all[244], 0.0), new Enemy(Chara.all[142], 0.0), new Enemy(Chara.all[93], 0.0), new Enemy(Chara.all[101], 0.0), new Enemy(Chara.all[171], 0.0)]),
new Difficulty(149, "感情こころ乱入クエスト(憂心の茄子面戦)", false, [new Enemy(Chara.all[244], 0.0), new Enemy(Chara.all[37], 0.0), new Enemy(Chara.all[152], 0.0), new Enemy(Chara.all[54], 0.0), new Enemy(Chara.all[77], 0.0)]),
new Difficulty(150, "感情こころ乱入クエスト(歓喜の半霊面戦)", false, [new Enemy(Chara.all[244], 0.0), new Enemy(Chara.all[157], 0.0), new Enemy(Chara.all[58], 0.0), new Enemy(Chara.all[191], 0.0), new Enemy(Chara.all[17], 0.0)]),
new Difficulty(151, "感情こころ乱入クエスト(狂喜の聖獣面戦)", false, [new Enemy(Chara.all[244], 0.0), new Enemy(Chara.all[197], 0.0), new Enemy(Chara.all[88], 0.0), new Enemy(Chara.all[95], 0.0), new Enemy(Chara.all[233], 0.0)]),
new Difficulty(152, "感情こころ乱入クエスト(憂嘆の長友面戦)", false, [new Enemy(Chara.all[244], 0.0), new Enemy(Chara.all[35], 0.0), new Enemy(Chara.all[128], 0.0), new Enemy(Chara.all[53], 0.0), new Enemy(Chara.all[76], 0.0)]),
new Difficulty(153, "蓬莱肛門科(EAS)", false, [new Enemy(Chara.all[239], 0.31), new Enemy(Chara.all[127], 0.31), new Enemy(Chara.all[81], 0.31), new Enemy(Chara.all[240], 0.31), new Enemy(Chara.all[80], 0.31), new Enemy(Chara.all[57], 0.31), new Enemy(Chara.all[238], 0.31), new Enemy(Chara.all[53], 0.31), new Enemy(Chara.all[79], 0.31), new Enemy(Chara.all[180], 0.31), new Enemy(Chara.all[181], 0.31), new Enemy(Chara.all[243], 1.0), new Enemy(Chara.all[241], 0.31), new Enemy(Chara.all[78], 0.31), new Enemy(Chara.all[139], 0.31), new Enemy(Chara.all[250], 0.11), new Enemy(Chara.all[251], 0.11), new Enemy(Chara.all[204], 0.31)]),
new Difficulty(154, "蓬莱肛門科(ADV)", false, [new Enemy(Chara.all[35], 0.31), new Enemy(Chara.all[33], 0.31), new Enemy(Chara.all[34], 0.31), new Enemy(Chara.all[32], 0.31), new Enemy(Chara.all[238], 0.31), new Enemy(Chara.all[240], 0.31), new Enemy(Chara.all[142], 0.31), new Enemy(Chara.all[4], 0.31), new Enemy(Chara.all[141], 0.31), new Enemy(Chara.all[36], 0.31), new Enemy(Chara.all[249], 0.31), new Enemy(Chara.all[76], 0.31), new Enemy(Chara.all[159], 0.31), new Enemy(Chara.all[193], 0.31), new Enemy(Chara.all[241], 0.31), new Enemy(Chara.all[181], 0.31), new Enemy(Chara.all[9], 0.31), new Enemy(Chara.all[16], 0.31), new Enemy(Chara.all[78], 0.31), new Enemy(Chara.all[88], 0.31), new Enemy(Chara.all[206], 0.31), new Enemy(Chara.all[220], 0.31), new Enemy(Chara.all[197], 0.31), new Enemy(Chara.all[250], 0.51), new Enemy(Chara.all[239], 0.31), new Enemy(Chara.all[105], 0.31), new Enemy(Chara.all[127], 0.31), new Enemy(Chara.all[51], 0.31), new Enemy(Chara.all[175], 0.31), new Enemy(Chara.all[158], 0.51), new Enemy(Chara.all[251], 0.51), new Enemy(Chara.all[194], 0.51)]),
new Difficulty(155, "蓬莱肛門科(EXH)", false, [new Enemy(Chara.all[221], 0.31), new Enemy(Chara.all[81], 0.31), new Enemy(Chara.all[127], 0.31), new Enemy(Chara.all[140], 0.31), new Enemy(Chara.all[238], 0.31), new Enemy(Chara.all[240], 0.31), new Enemy(Chara.all[142], 0.31), new Enemy(Chara.all[4], 0.31), new Enemy(Chara.all[141], 0.31), new Enemy(Chara.all[52], 0.31), new Enemy(Chara.all[196], 0.31), new Enemy(Chara.all[109], 0.31), new Enemy(Chara.all[180], 0.31), new Enemy(Chara.all[191], 0.31), new Enemy(Chara.all[234], 1.0), new Enemy(Chara.all[38], 0.0), new Enemy(Chara.all[27], 0.0), new Enemy(Chara.all[41], 0.0), new Enemy(Chara.all[42], 0.0), new Enemy(Chara.all[249], 0.31), new Enemy(Chara.all[76], 0.31), new Enemy(Chara.all[159], 0.31), new Enemy(Chara.all[193], 0.31), new Enemy(Chara.all[246], 0.31), new Enemy(Chara.all[35], 0.31), new Enemy(Chara.all[247], 0.31), new Enemy(Chara.all[139], 0.31), new Enemy(Chara.all[241], 0.31), new Enemy(Chara.all[88], 0.31), new Enemy(Chara.all[60], 0.31), new Enemy(Chara.all[172], 0.31), new Enemy(Chara.all[79], 0.31), new Enemy(Chara.all[111], 0.31), new Enemy(Chara.all[35], 0.31), new Enemy(Chara.all[12], 0.31), new Enemy(Chara.all[206], 0.31), new Enemy(Chara.all[242], 0.31), new Enemy(Chara.all[251], 0.51), new Enemy(Chara.all[250], 0.31), new Enemy(Chara.all[88], 0.51)]),
new Difficulty(156, "ALC一派襲来！(EAS)", false, [new Enemy(Chara.all[239], 0.31), new Enemy(Chara.all[240], 0.31), new Enemy(Chara.all[238], 0.31), new Enemy(Chara.all[208], 0.31), new Enemy(Chara.all[137], 0.31), new Enemy(Chara.all[258], 1.0), new Enemy(Chara.all[127], 0.51), new Enemy(Chara.all[249], 0.31)]),
new Difficulty(157, "ALC一派襲来！(ADV)", false, [new Enemy(Chara.all[210], 0.31), new Enemy(Chara.all[209], 0.31), new Enemy(Chara.all[205], 0.31), new Enemy(Chara.all[206], 0.31), new Enemy(Chara.all[78], 0.31), new Enemy(Chara.all[211], 0.31), new Enemy(Chara.all[141], 0.31), new Enemy(Chara.all[140], 0.31), new Enemy(Chara.all[259], 1.0), new Enemy(Chara.all[77], 0.51), new Enemy(Chara.all[128], 0.31)]),
new Difficulty(158, "ALC一派襲来！(EXH)", false, [new Enemy(Chara.all[210], 0.31), new Enemy(Chara.all[209], 0.31), new Enemy(Chara.all[205], 0.31), new Enemy(Chara.all[206], 0.31), new Enemy(Chara.all[78], 0.31), new Enemy(Chara.all[233], 0.31), new Enemy(Chara.all[193], 0.31), new Enemy(Chara.all[81], 0.31), new Enemy(Chara.all[234], 0.31), new Enemy(Chara.all[246], 0.31), new Enemy(Chara.all[35], 0.31), new Enemy(Chara.all[153], 0.31), new Enemy(Chara.all[88], 0.31), new Enemy(Chara.all[212], 0.51), new Enemy(Chara.all[220], 0.51), new Enemy(Chara.all[260], 1.0), new Enemy(Chara.all[152], 0.51), new Enemy(Chara.all[126], 0.31), new Enemy(Chara.all[88], 0.51), new Enemy(Chara.all[52], 0.51)]),
new Difficulty(159, "ALC一派襲来！(LEG)", false, [new Enemy(Chara.all[159], 0.31), new Enemy(Chara.all[249], 0.31), new Enemy(Chara.all[76], 0.31), new Enemy(Chara.all[219], 0.31), new Enemy(Chara.all[142], 0.31), new Enemy(Chara.all[141], 0.31), new Enemy(Chara.all[240], 0.31), new Enemy(Chara.all[208], 0.31), new Enemy(Chara.all[4], 0.31), new Enemy(Chara.all[194], 0.31), new Enemy(Chara.all[175], 0.31), new Enemy(Chara.all[195], 0.31), new Enemy(Chara.all[158], 0.31), new Enemy(Chara.all[209], 0.31), new Enemy(Chara.all[210], 0.31), new Enemy(Chara.all[205], 0.31), new Enemy(Chara.all[77], 0.31), new Enemy(Chara.all[67], 0.31), new Enemy(Chara.all[59], 0.31), new Enemy(Chara.all[241], 0.31), new Enemy(Chara.all[60], 0.31), new Enemy(Chara.all[212], 0.31), new Enemy(Chara.all[213], 0.31), new Enemy(Chara.all[80], 0.31), new Enemy(Chara.all[79], 0.31), new Enemy(Chara.all[89], 0.31), new Enemy(Chara.all[71], 0.31), new Enemy(Chara.all[250], 0.31), new Enemy(Chara.all[88], 0.31), new Enemy(Chara.all[234], 0.31), new Enemy(Chara.all[42], 0.31), new Enemy(Chara.all[26], 0.31), new Enemy(Chara.all[223], 0.31), new Enemy(Chara.all[38], 0.31), new Enemy(Chara.all[3], 0.31), new Enemy(Chara.all[135], 0.31), new Enemy(Chara.all[251], 0.31), new Enemy(Chara.all[238], 0.31), new Enemy(Chara.all[157], 0.31), new Enemy(Chara.all[211], 0.31), new Enemy(Chara.all[207], 0.31), new Enemy(Chara.all[139], 0.31), new Enemy(Chara.all[140], 0.31), new Enemy(Chara.all[127], 0.31), new Enemy(Chara.all[257], 1.0), new Enemy(Chara.all[81], 0.31), new Enemy(Chara.all[140], 0.31), new Enemy(Chara.all[261], 1.0), new Enemy(Chara.all[258], 0.31), new Enemy(Chara.all[259], 0.31), new Enemy(Chara.all[260], 0.31), new Enemy(Chara.all[1], 0.0), new Enemy(Chara.all[262], 1.0), new Enemy(Chara.all[79], 0.0), new Enemy(Chara.all[206], 0.0), new Enemy(Chara.all[157], 0.0)]),
new Difficulty(160, "セミ兄貴の森(EAS)", false, [new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[50], 0.31), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0)]),
new Difficulty(161, "セミ兄貴の森(ADV)", false, [new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[50], 0.61), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0)]),
new Difficulty(162, "セミ兄貴の森(EXH)", false, [new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[50], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0)]),
...
new Difficulty(164, "妖精の森(EAS)", false, [new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[47], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[46], 0.0), new Enemy(Chara.all[118], 1.0), new Enemy(Chara.all[119], 1.0), new Enemy(Chara.all[121], 0.0), new Enemy(Chara.all[122], 0.0), new Enemy(Chara.all[120], 0.0)]),
new Difficulty(165, "妖精の森(ADV)", false, [new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[47], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[46], 0.0), new Enemy(Chara.all[5], 1.0), new Enemy(Chara.all[49], 0.0), new Enemy(Chara.all[118], 1.0), new Enemy(Chara.all[119], 0.51), new Enemy(Chara.all[121], 1.0), new Enemy(Chara.all[122], 1.0), new Enemy(Chara.all[120], 1.0)]),
new Difficulty(166, "妖精の森(EXH)", false, [new Enemy(Chara.all[118], 1.0), new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[7], 0.0), new Enemy(Chara.all[47], 0.0), new Enemy(Chara.all[119], 1.0), new Enemy(Chara.all[5], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[118], 0.0), new Enemy(Chara.all[46], 0.0), new Enemy(Chara.all[120], 1.0), new Enemy(Chara.all[121], 0.0), new Enemy(Chara.all[123], 1.0), new Enemy(Chara.all[118], 1.0), new Enemy(Chara.all[45], 0.0), new Enemy(Chara.all[122], 1.0), new Enemy(Chara.all[49], 0.0), new Enemy(Chara.all[5], 1.0), new Enemy(Chara.all[7], 1.0), new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[118], 1.0), new Enemy(Chara.all[120], 1.0), new Enemy(Chara.all[121], 1.0), new Enemy(Chara.all[124], 1.0), new Enemy(Chara.all[123], 1.0)]),
new Difficulty(167, "妖精の森(LEG)", false, [new Enemy(Chara.all[118], 1.0), new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[157], 0.0), new Enemy(Chara.all[7], 0.0), new Enemy(Chara.all[47], 0.0), new Enemy(Chara.all[119], 1.0), new Enemy(Chara.all[5], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[118], 0.0), new Enemy(Chara.all[46], 0.0), new Enemy(Chara.all[177], 1.0), new Enemy(Chara.all[5], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[122], 0.0), new Enemy(Chara.all[46], 0.0), new Enemy(Chara.all[120], 1.0), new Enemy(Chara.all[121], 0.0), new Enemy(Chara.all[123], 1.0), new Enemy(Chara.all[118], 1.0), new Enemy(Chara.all[45], 0.0), new Enemy(Chara.all[122], 1.0), new Enemy(Chara.all[49], 0.0), new Enemy(Chara.all[5], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[178], 1.0), new Enemy(Chara.all[119], 0.0), new Enemy(Chara.all[118], 1.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[179], 1.0), new Enemy(Chara.all[120], 1.0), new Enemy(Chara.all[118], 1.0), new Enemy(Chara.all[124], 1.0)]),
new Difficulty(168, "BBの森(EAS)", false, [new Enemy(Chara.all[198], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[199], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[200], 0.31), new Enemy(Chara.all[46], 0.0)]),
new Difficulty(169, "BBの森(ADV)", false, [new Enemy(Chara.all[157], 0.31), new Enemy(Chara.all[47], 0.0), new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[201], 0.31), new Enemy(Chara.all[49], 0.0), new Enemy(Chara.all[200], 1.0), new Enemy(Chara.all[199], 1.0), new Enemy(Chara.all[47], 0.0), new Enemy(Chara.all[104], 0.0), new Enemy(Chara.all[153], 0.0), new Enemy(Chara.all[28], 0.0), new Enemy(Chara.all[202], 0.31), new Enemy(Chara.all[48], 0.0), new Enemy(Chara.all[118], 0.0), new Enemy(Chara.all[120], 0.0), new Enemy(Chara.all[122], 0.0), new Enemy(Chara.all[203], 0.31), new Enemy(Chara.all[45], 0.0), new Enemy(Chara.all[4], 0.0), new Enemy(Chara.all[123], 0.0), new Enemy(Chara.all[198], 1.0)]),
new Difficulty(170, "BBの森(EXH)", false, [new Enemy(Chara.all[252], 0.31), new Enemy(Chara.all[49], 0.0), new Enemy(Chara.all[118], 0.0), new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[157], 0.0), new Enemy(Chara.all[7], 0.0), new Enemy(Chara.all[47], 0.0), new Enemy(Chara.all[255], 0.31), new Enemy(Chara.all[198], 0.31), new Enemy(Chara.all[45], 0.31), new Enemy(Chara.all[112], 0.0), new Enemy(Chara.all[50], 0.0), new Enemy(Chara.all[254], 0.31), new Enemy(Chara.all[228], 0.0), new Enemy(Chara.all[253], 0.31), new Enemy(Chara.all[120], 0.0), new Enemy(Chara.all[124], 0.31), new Enemy(Chara.all[118], 0.0), new Enemy(Chara.all[199], 0.31), new Enemy(Chara.all[202], 0.31), new Enemy(Chara.all[203], 0.31), new Enemy(Chara.all[201], 0.31), new Enemy(Chara.all[256], 0.31), new Enemy(Chara.all[200], 0.31), new Enemy(Chara.all[253], 0.31), new Enemy(Chara.all[12], 0.0)])
];
