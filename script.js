...
new Chara(43, "SIY", 45),
new Chara(44, "GO", 46),
new Chara(45, "レッドセミ兄貴", 160),
new Chara(46, "ブルーセミ兄貴", 161),
new Chara(47, "セミ兄貴", 162),
new Chara(48, "光に満ちたセミ兄貴", 163),
new Chara(49, "闇に堕ちたセミ兄貴", 164),
new Chara(50, "メガカイロSIK", 165),
new Chara(51, "サマーMSTA姉貴", 184),
new Chara(52, "バレンタインRIM", 188),
new Chara(53, "バレンタインUDK", 189),
new Chara(54, "バレンタインALC", 190),
new Chara(55, "YKR姉貴", 220),
new Chara(56, "邪神GO", 221),
new Chara(57, "SNE姉貴", 125),
new Chara(58, "SWK様", 126),
new Chara(59, "風神KNK", 127),
new Chara(60, "神々の頂点SWK", 128),
new Chara(61, "イワナを焼くUDK", 119),
new Chara(62, "サマーRIM姉貴", 185),
new Chara(63, "サマーUDK姉貴", 186),
new Chara(64, "サマーALC姉貴", 187),
new Chara(65, "サマーHZR姉貴", 191),
new Chara(66, "サマーピンキー姉貴", 197),
...
new Chara(76, "YMMちゃん", 132),
new Chara(77, "PLSY姉貴", 133),
new Chara(78, "YUG姉貴", 134),
new Chara(79, "STR姉貴", 135),
new Chara(80, "ORN姉貴", 136),
new Chara(81, "KISちゃん", 137),
new Chara(82, "太陽神NDK", 138),
...
new Chara(90, "たまドラ田中", 217),
new Chara(91, "MMJ姉貴", 183),
new Chara(92, "いなり男", 63),
new Chara(93, "AKG", 64),
new Chara(94, "関西クレーマー", 65),
new Chara(95, "現場監督", 66),
new Chara(96, "変態郵便屋", 110),
new Chara(97, "インパルスITKR", 111),
new Chara(98, "小森", 112),
new Chara(99, "ホリ・トオル", 113),
new Chara(100, "ラザマリナ", 120),
...
new Chara(109, "植木鉢くん", 109),
new Chara(110, "PSR姉貴", 129),
new Chara(111, "化物と化したPSR姉貴", 130),
new Chara(112, "全てを狩る先輩", 166),
new Chara(113, "花嫁と化した先輩", 192),
new Chara(114, "嫁TIT", 193),
new Chara(115, "花嫁ピンキー", 194),
new Chara(116, "ノンケスレイヤー", 195),
new Chara(117, "BSTIT", 196),
new Chara(118, "ビリー兄貴", 167),
new Chara(119, "木吉カズヤ", 168),
new Chara(120, "井上カブレラ", 169),
new Chara(121, "いかりやビオランテ", 170),
new Chara(122, "TDNコスギ", 171),
new Chara(123, "赤さん", 172),
new Chara(124, "VAN様", 173),
new Chara(125, "カグラ=ウヅキ", 121),
new Chara(126, "ESKちゃん", 198),
new Chara(127, "YW姉貴", 199),
new Chara(128, "ITUASK", 200),
new Chara(129, "バンホーテンダー", 122),
new Chara(130, "MZ姉貴", 201),
new Chara(131, "AZS姉貴", 202),
new Chara(132, "RI姉貴", 203),
new Chara(133, "朗読兄貴", 204),
new Chara(134, "デビルひで", 140),
new Chara(135, "ナイトメアビリー兄貴", 141),
new Chara(136, "ベルモンド先輩", 142),
new Chara(137, "ナイトメアMIRN姉貴", 143),
new Chara(138, "ナイトメアKSDB姉貴", 144),
new Chara(139, "ナイトメアPCLY姉貴", 145),
new Chara(140, "ナイトメアSKY姉貴", 146),
new Chara(141, "ナイトメアRMLA姉貴", 147),
new Chara(142, "ナイトメアFLNちゃん", 148),
new Chara(143, "スカーレット内閣", 149),
new Chara(144, "黄金のSWK様", 131),
new Chara(145, "ZNM姉貴", 139),
...
new Chara(155, "中盤に出てくる鳥", 216),
new Chara(156, "ダークロウ先輩", 123),
new Chara(157, "交通整理DIちゃん", 108),
new Chara(158, "世界のトオノ", 114),
new Chara(159, "ビューティ先輩", 115),
new Chara(160, "ミミックおばさん", 150),
new Chara(161, "メカNDK", 124),
new Chara(162, "AY姉貴", 211),
new Chara(163, "TNS姉貴", 212),
new Chara(164, "HTT姉貴", 213),
new Chara(165, "MDCNちゃん", 214),
new Chara(166, "RNNSK兄貴", 215),
new Chara(167, "逝かせ隊", 84),
new Chara(168, "ポイテーロ", 85),
new Chara(169, "ウルトラマンタクヤ", 116),
new Chara(170, "LNK", 86),
new Chara(171, "キモヲタ平野", 89),
new Chara(172, "TNKL", 87),
new Chara(173, "うさぎ", 88),
new Chara(174, "タナトスひで", 90),
new Chara(175, "Y.AOI", 151),
new Chara(176, "メガMTGRS先輩", 152),
new Chara(177, "須藤さん", 174),
new Chara(178, "池田茂美", 175),
new Chara(179, "妖精王チチラルー", 176),
new Chara(180, "ALISON兄貴", 209),
new Chara(181, "ZUN", 210),
new Chara(182, "チャリオット平野", 205),
new Chara(183, "剣聖おじさん", 206),
new Chara(184, "破面KBTIT", 207),
new Chara(185, "AKMRくん", 208),
...
new Chara(197, "完全勝利した淫夢くんUC", 218),
new Chara(198, "風来人RU", 177),
new Chara(199, "ESKドラゴン", 178),
new Chara(200, "ジャボテンダーALC", 179),
new Chara(201, "多脚ひで", 180),
new Chara(202, "ピン鬼", 181),
new Chara(203, "ダークドレアム先輩", 182),
new Chara(204, "釣リスマスおばさん", 219),
new Chara(205, "GTさん", 117),
new Chara(206, "超能力者ONDISK", 118),
new Chara(207, "NZRN", 153),
new Chara(208, "KGSちゃん", 154),
new Chara(209, "ICRN姉貴", 155),
new Chara(210, "MRS姉貴", 156),
new Chara(211, "SYOU姉貴", 157),
new Chara(212, "HZR姉貴", 158),
new Chara(213, "NUEちゃん", 159),
...
new Difficulty(78, "守矢神社(EAS)", true, [new Enemy(Chara.all[5], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[4], 0.0), new Enemy(Chara.all[10], 1.0), new Enemy(Chara.all[11], 1.0), new Enemy(Chara.all[8], 1.0), new Enemy(Chara.all[9], 1.0), new Enemy(Chara.all[12], 1.0), new Enemy(Chara.all[15], 1.0), new Enemy(Chara.all[14], 1.0), new Enemy(Chara.all[13], 0.51), new Enemy(Chara.all[57], 1.0), new Enemy(Chara.all[58], 0.31), new Enemy(Chara.all[39], 0.31), new Enemy(Chara.all[37], 0.31)]),
new Difficulty(79, "守矢神社(ADV)", true, [new Enemy(Chara.all[5], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[4], 0.0), new Enemy(Chara.all[10], 1.0), new Enemy(Chara.all[11], 1.0), new Enemy(Chara.all[8], 1.0), new Enemy(Chara.all[9], 1.0), new Enemy(Chara.all[12], 1.0), new Enemy(Chara.all[15], 1.0), new Enemy(Chara.all[14], 1.0), new Enemy(Chara.all[13], 0.81), new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[27], 1.0), new Enemy(Chara.all[31], 1.0), new Enemy(Chara.all[43], 1.0), new Enemy(Chara.all[25], 1.0), new Enemy(Chara.all[30], 1.0), new Enemy(Chara.all[59], 0.31), new Enemy(Chara.all[58], 1.0), new Enemy(Chara.all[57], 1.0), new Enemy(Chara.all[39], 0.51)]),
new Difficulty(80, "守矢神社(EXH)", true, [new Enemy(Chara.all[5], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[4], 0.0), new Enemy(Chara.all[10], 1.0), new Enemy(Chara.all[11], 1.0), new Enemy(Chara.all[8], 1.0), new Enemy(Chara.all[9], 1.0), new Enemy(Chara.all[12], 1.0), new Enemy(Chara.all[15], 1.0), new Enemy(Chara.all[14], 1.0), new Enemy(Chara.all[13], 0.81), new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[27], 1.0), new Enemy(Chara.all[19], 1.0), new Enemy(Chara.all[43], 1.0), new Enemy(Chara.all[20], 1.0), new Enemy(Chara.all[30], 1.0), new Enemy(Chara.all[29], 1.0), new Enemy(Chara.all[42], 1.0), new Enemy(Chara.all[28], 1.0), new Enemy(Chara.all[23], 1.0), new Enemy(Chara.all[38], 1.0), new Enemy(Chara.all[41], 0.31), new Enemy(Chara.all[37], 0.51), new Enemy(Chara.all[22], 0.51), new Enemy(Chara.all[25], 1.0), new Enemy(Chara.all[59], 1.0), new Enemy(Chara.all[58], 1.0), new Enemy(Chara.all[57], 1.0), new Enemy(Chara.all[39], 1.0)]),
new Difficulty(81, "守矢神社(LEG)", true, [new Enemy(Chara.all[5], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[4], 0.0), new Enemy(Chara.all[10], 0.0), new Enemy(Chara.all[11], 0.0), new Enemy(Chara.all[8], 0.0), new Enemy(Chara.all[9], 0.0), new Enemy(Chara.all[12], 0.0), new Enemy(Chara.all[15], 0.0), new Enemy(Chara.all[14], 0.0), new Enemy(Chara.all[13], 0.51), new Enemy(Chara.all[18], 0.0), new Enemy(Chara.all[27], 0.0), new Enemy(Chara.all[19], 0.0), new Enemy(Chara.all[43], 1.0), new Enemy(Chara.all[20], 0.0), new Enemy(Chara.all[30], 0.51), new Enemy(Chara.all[29], 0.0), new Enemy(Chara.all[42], 0.51), new Enemy(Chara.all[28], 0.51), new Enemy(Chara.all[23], 0.0), new Enemy(Chara.all[38], 0.51), new Enemy(Chara.all[41], 0.31), new Enemy(Chara.all[37], 0.51), new Enemy(Chara.all[22], 0.51), new Enemy(Chara.all[25], 0.51), new Enemy(Chara.all[29], 0.51), new Enemy(Chara.all[42], 1.0), new Enemy(Chara.all[28], 0.51), new Enemy(Chara.all[37], 0.51), new Enemy(Chara.all[22], 0.0), new Enemy(Chara.all[25], 0.51), new Enemy(Chara.all[59], 1.0), new Enemy(Chara.all[60], 1.0), new Enemy(Chara.all[57], 1.0)]),
new Difficulty(82, "真夏の水着ユニット乱入フェスティバル(サマーMSTA姉貴戦)", true, [new Enemy(Chara.all[51], 1.0), new Enemy(Chara.all[12], 0.51), new Enemy(Chara.all[5], 0.51), new Enemy(Chara.all[10], 0.51), new Enemy(Chara.all[4], 0.51)]),
new Difficulty(83, "真夏の水着ユニット乱入フェスティバル(サマーRIM姉貴戦)", true, [new Enemy(Chara.all[62], 1.0), new Enemy(Chara.all[53], 0.51), new Enemy(Chara.all[54], 0.51), new Enemy(Chara.all[5], 0.51), new Enemy(Chara.all[6], 0.51)]),
new Difficulty(84, "真夏の水着ユニット乱入フェスティバル(サマーUDK姉貴戦)", true, [new Enemy(Chara.all[63], 1.0), new Enemy(Chara.all[52], 0.51), new Enemy(Chara.all[54], 0.51), new Enemy(Chara.all[17], 0.51), new Enemy(Chara.all[7], 0.51)]),
new Difficulty(85, "真夏の水着ユニット乱入フェスティバル(サマーALC姉貴戦)", true, [new Enemy(Chara.all[64], 1.0), new Enemy(Chara.all[52], 0.51), new Enemy(Chara.all[53], 0.51), new Enemy(Chara.all[12], 0.51), new Enemy(Chara.all[11], 0.51)]),
new Difficulty(86, "真夏の水着ユニット乱入フェスティバル(サマーHZR姉貴戦)", true, [new Enemy(Chara.all[65], 1.0), new Enemy(Chara.all[62], 0.51), new Enemy(Chara.all[63], 0.51), new Enemy(Chara.all[64], 0.51)]),
new Difficulty(87, "真夏の水着ユニット乱入フェスティバル(サマーピンキー姉貴戦)", true, [new Enemy(Chara.all[66], 1.0), new Enemy(Chara.all[51], 0.51), new Enemy(Chara.all[51], 0.51), new Enemy(Chara.all[51], 0.51)]),
new Difficulty(88, "地霊殿(EAS)", true, [new Enemy(Chara.all[5], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[76], 1.0), new Enemy(Chara.all[9], 0.51), new Enemy(Chara.all[7], 0.51), new Enemy(Chara.all[77], 0.31), new Enemy(Chara.all[14], 0.51), new Enemy(Chara.all[12], 0.51), new Enemy(Chara.all[78], 0.11), new Enemy(Chara.all[9], 0.0), new Enemy(Chara.all[4], 0.51), new Enemy(Chara.all[79], 0.06), new Enemy(Chara.all[8], 0.31), new Enemy(Chara.all[17], 0.31), new Enemy(Chara.all[7], 0.31)]),
new Difficulty(89, "地霊殿(ADV)", true, [new Enemy(Chara.all[5], 0.11), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[13], 0.0), new Enemy(Chara.all[76], 1.0), new Enemy(Chara.all[9], 0.0), new Enemy(Chara.all[4], 0.51), new Enemy(Chara.all[3], 0.51), new Enemy(Chara.all[32], 0.51), new Enemy(Chara.all[33], 0.0), new Enemy(Chara.all[34], 0.0), new Enemy(Chara.all[77], 0.51), new Enemy(Chara.all[14], 0.0), new Enemy(Chara.all[18], 0.21), new Enemy(Chara.all[26], 0.0), new Enemy(Chara.all[21], 0.51), new Enemy(Chara.all[28], 0.0), new Enemy(Chara.all[39], 0.0), new Enemy(Chara.all[78], 0.31), new Enemy(Chara.all[35], 0.51), new Enemy(Chara.all[41], 0.51), new Enemy(Chara.all[17], 0.51), new Enemy(Chara.all[79], 0.21), new Enemy(Chara.all[8], 0.31), new Enemy(Chara.all[80], 0.31), new Enemy(Chara.all[7], 0.31), new Enemy(Chara.all[36], 0.31)]),
new Difficulty(90, "地霊殿(EXH)", true, [new Enemy(Chara.all[5], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[14], 0.0), new Enemy(Chara.all[15], 0.31), new Enemy(Chara.all[68], 0.0), new Enemy(Chara.all[29], 0.0), new Enemy(Chara.all[28], 0.0), new Enemy(Chara.all[30], 0.0), new Enemy(Chara.all[76], 1.0), new Enemy(Chara.all[35], 0.0), new Enemy(Chara.all[72], 0.0), new Enemy(Chara.all[12], 0.0), new Enemy(Chara.all[32], 0.51), new Enemy(Chara.all[33], 0.0), new Enemy(Chara.all[34], 0.0), new Enemy(Chara.all[42], 0.0), new Enemy(Chara.all[77], 1.0), new Enemy(Chara.all[14], 0.0), new Enemy(Chara.all[18], 0.0), new Enemy(Chara.all[67], 1.0), new Enemy(Chara.all[21], 1.0), new Enemy(Chara.all[28], 0.0), new Enemy(Chara.all[39], 0.0), new Enemy(Chara.all[70], 0.31), new Enemy(Chara.all[78], 1.0), new Enemy(Chara.all[35], 0.51), new Enemy(Chara.all[41], 0.51), new Enemy(Chara.all[17], 0.51), new Enemy(Chara.all[44], 1.0), new Enemy(Chara.all[43], 0.51), new Enemy(Chara.all[11], 0.51), new Enemy(Chara.all[22], 0.51), new Enemy(Chara.all[76], 1.0), new Enemy(Chara.all[77], 0.51), new Enemy(Chara.all[78], 0.51), new Enemy(Chara.all[80], 0.51), new Enemy(Chara.all[79], 1.0), new Enemy(Chara.all[8], 0.31), new Enemy(Chara.all[80], 1.0), new Enemy(Chara.all[81], 0.31), new Enemy(Chara.all[36], 0.31)]),
new Difficulty(91, "地霊殿(LEG)", true, [new Enemy(Chara.all[5], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[14], 0.0), new Enemy(Chara.all[15], 0.31), new Enemy(Chara.all[69], 0.31), new Enemy(Chara.all[68], 0.0), new Enemy(Chara.all[29], 0.0), new Enemy(Chara.all[28], 0.0), new Enemy(Chara.all[30], 0.0), new Enemy(Chara.all[76], 1.0), new Enemy(Chara.all[35], 0.0), new Enemy(Chara.all[72], 0.0), new Enemy(Chara.all[72], 0.0), new Enemy(Chara.all[12], 0.0), new Enemy(Chara.all[32], 0.51), new Enemy(Chara.all[33], 0.0), new Enemy(Chara.all[34], 0.0), new Enemy(Chara.all[35], 0.0), new Enemy(Chara.all[42], 0.0), new Enemy(Chara.all[77], 1.0), new Enemy(Chara.all[14], 0.0), new Enemy(Chara.all[18], 0.0), new Enemy(Chara.all[69], 1.0), new Enemy(Chara.all[67], 1.0), new Enemy(Chara.all[21], 1.0), new Enemy(Chara.all[28], 0.0), new Enemy(Chara.all[39], 0.0), new Enemy(Chara.all[70], 0.31), new Enemy(Chara.all[78], 1.0), new Enemy(Chara.all[35], 0.51), new Enemy(Chara.all[41], 0.51), new Enemy(Chara.all[17], 0.51), new Enemy(Chara.all[44], 1.0), new Enemy(Chara.all[43], 0.51), new Enemy(Chara.all[11], 0.51), new Enemy(Chara.all[22], 0.51), new Enemy(Chara.all[76], 1.0), new Enemy(Chara.all[77], 0.51), new Enemy(Chara.all[78], 0.51), new Enemy(Chara.all[80], 0.51), new Enemy(Chara.all[79], 1.0), new Enemy(Chara.all[8], 0.31), new Enemy(Chara.all[80], 1.0), new Enemy(Chara.all[81], 0.31), new Enemy(Chara.all[36], 0.31), new Enemy(Chara.all[82], 1.0), new Enemy(Chara.all[81], 0.0), new Enemy(Chara.all[79], 0.0)]),
new Difficulty(92, "スマブラ発売記念乱入クエスト(変態郵便屋戦)", true, [new Enemy(Chara.all[96], 0.71), new Enemy(Chara.all[52], 0.51), new Enemy(Chara.all[12], 0.51), new Enemy(Chara.all[28], 0.51), new Enemy(Chara.all[84], 0.51)]),
new Difficulty(93, "スマブラ発売記念乱入クエスト(インパルスITKR戦)", true, [new Enemy(Chara.all[97], 0.31), new Enemy(Chara.all[53], 0.51), new Enemy(Chara.all[35], 0.0), new Enemy(Chara.all[41], 0.51), new Enemy(Chara.all[12], 0.51)]),
new Difficulty(94, "スマブラ発売記念乱入クエスト(小森戦)", true, [new Enemy(Chara.all[98], 1.0), new Enemy(Chara.all[54], 0.51), new Enemy(Chara.all[67], 0.0), new Enemy(Chara.all[4], 0.0), new Enemy(Chara.all[6], 0.0)]),
new Difficulty(95, "スマブラ発売記念乱入クエスト(ホリ・トオル戦)", true, [new Enemy(Chara.all[99], 1.0), new Enemy(Chara.all[65], 1.0), new Enemy(Chara.all[89], 0.0)]),
new Difficulty(96, "まりりんぴっく　ちびっこの部(EAS)", true, [new Enemy(Chara.all[5], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[52], 1.0), new Enemy(Chara.all[62], 0.51), new Enemy(Chara.all[102], 0.51), new Enemy(Chara.all[7], 0.51), new Enemy(Chara.all[126], 0.11), new Enemy(Chara.all[8], 0.31), new Enemy(Chara.all[17], 0.31)]),
new Difficulty(97, "まりりんぴっく　ちびっこの部(ADV)", true, [new Enemy(Chara.all[5], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[52], 1.0), new Enemy(Chara.all[84], 0.51), new Enemy(Chara.all[93], 0.51), new Enemy(Chara.all[95], 0.51), new Enemy(Chara.all[20], 0.51), new Enemy(Chara.all[57], 0.51), new Enemy(Chara.all[58], 0.51), new Enemy(Chara.all[62], 1.0), new Enemy(Chara.all[102], 1.0), new Enemy(Chara.all[7], 0.51), new Enemy(Chara.all[126], 0.31), new Enemy(Chara.all[28], 0.31), new Enemy(Chara.all[17], 0.31), new Enemy(Chara.all[109], 0.31)]),
new Difficulty(98, "まりりんぴっく　ちびっこの部(EXH)", true, [new Enemy(Chara.all[5], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[52], 1.0), new Enemy(Chara.all[84], 0.31), new Enemy(Chara.all[62], 0.51), new Enemy(Chara.all[102], 0.51), new Enemy(Chara.all[7], 0.51), new Enemy(Chara.all[67], 0.31), new Enemy(Chara.all[104], 0.51), new Enemy(Chara.all[38], 0.51), new Enemy(Chara.all[17], 0.51), new Enemy(Chara.all[57], 0.51), new Enemy(Chara.all[58], 0.51), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[126], 1.0), new Enemy(Chara.all[88], 0.31), new Enemy(Chara.all[123], 0.31), new Enemy(Chara.all[89], 0.31)]),
new Difficulty(99, "まりりんぴっく　応援団の部(EAS)", true, [new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[4], 0.0), new Enemy(Chara.all[53], 1.0), new Enemy(Chara.all[63], 0.51), new Enemy(Chara.all[101], 0.51), new Enemy(Chara.all[10], 0.51), new Enemy(Chara.all[127], 0.11), new Enemy(Chara.all[9], 0.31), new Enemy(Chara.all[51], 0.31)]),
new Difficulty(100, "まりりんぴっく　応援団の部(ADV)", true, [new Enemy(Chara.all[11], 0.0), new Enemy(Chara.all[12], 0.0), new Enemy(Chara.all[53], 1.0), new Enemy(Chara.all[25], 0.51), new Enemy(Chara.all[36], 0.51), new Enemy(Chara.all[22], 0.51), new Enemy(Chara.all[19], 0.51), new Enemy(Chara.all[59], 0.51), new Enemy(Chara.all[63], 1.0), new Enemy(Chara.all[101], 1.0), new Enemy(Chara.all[7], 0.51), new Enemy(Chara.all[127], 0.31), new Enemy(Chara.all[105], 0.31), new Enemy(Chara.all[8], 0.31), new Enemy(Chara.all[7], 0.31)]),
new Difficulty(101, "まりりんぴっく　応援団の部(EXH)", true, [new Enemy(Chara.all[67], 0.0), new Enemy(Chara.all[12], 0.0), new Enemy(Chara.all[53], 1.0), new Enemy(Chara.all[11], 0.31), new Enemy(Chara.all[109], 0.31), new Enemy(Chara.all[63], 0.51), new Enemy(Chara.all[101], 0.51), new Enemy(Chara.all[7], 0.51), new Enemy(Chara.all[67], 0.31), new Enemy(Chara.all[35], 0.51), new Enemy(Chara.all[41], 0.51), new Enemy(Chara.all[72], 0.51), new Enemy(Chara.all[59], 0.51), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[127], 1.0), new Enemy(Chara.all[18], 0.31), new Enemy(Chara.all[20], 0.31), new Enemy(Chara.all[21], 0.31)]),
new Difficulty(102, "まりりんぴっく　父兄の部(EAS)", true, [new Enemy(Chara.all[9], 0.0), new Enemy(Chara.all[14], 0.0), new Enemy(Chara.all[54], 1.0), new Enemy(Chara.all[64], 0.51), new Enemy(Chara.all[103], 0.51), new Enemy(Chara.all[15], 0.51), new Enemy(Chara.all[128], 0.11), new Enemy(Chara.all[13], 0.31), new Enemy(Chara.all[16], 0.31)]),
new Difficulty(103, "まりりんぴっく　父兄の部(ADV)", true, [new Enemy(Chara.all[11], 0.0), new Enemy(Chara.all[12], 0.0), new Enemy(Chara.all[54], 1.0), new Enemy(Chara.all[25], 0.51), new Enemy(Chara.all[85], 0.51), new Enemy(Chara.all[74], 0.51), new Enemy(Chara.all[18], 0.51), new Enemy(Chara.all[60], 0.51), new Enemy(Chara.all[64], 1.0), new Enemy(Chara.all[103], 1.0), new Enemy(Chara.all[7], 0.51), new Enemy(Chara.all[128], 0.31), new Enemy(Chara.all[51], 0.31), new Enemy(Chara.all[17], 0.31), new Enemy(Chara.all[7], 0.31)]),
new Difficulty(104, "まりりんぴっく　父兄の部(EXH)", true, [new Enemy(Chara.all[15], 0.0), new Enemy(Chara.all[16], 0.0), new Enemy(Chara.all[54], 1.0), new Enemy(Chara.all[10], 0.0), new Enemy(Chara.all[13], 0.0), new Enemy(Chara.all[64], 0.51), new Enemy(Chara.all[103], 0.51), new Enemy(Chara.all[12], 0.51), new Enemy(Chara.all[68], 0.31), new Enemy(Chara.all[88], 0.51), new Enemy(Chara.all[26], 0.51), new Enemy(Chara.all[39], 0.51), new Enemy(Chara.all[60], 0.51), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[128], 1.0), new Enemy(Chara.all[35], 0.31), new Enemy(Chara.all[32], 0.31), new Enemy(Chara.all[33], 0.31), new Enemy(Chara.all[34], 0.31)]),
new Difficulty(105, "体育の日乱入クエスト(野獣&遠野戦)", true, [new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[19], 0.0), new Enemy(Chara.all[128], 0.0), new Enemy(Chara.all[127], 0.0), new Enemy(Chara.all[126], 0.0)]),
new Difficulty(106, "UDK姉妹乱入クエスト(MZ姉貴戦)", true, [new Enemy(Chara.all[130], 1.0), new Enemy(Chara.all[126], 0.21), new Enemy(Chara.all[5], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[4], 0.0)]),
new Difficulty(107, "UDK姉妹乱入クエスト(AZS姉貴戦)", true, [new Enemy(Chara.all[131], 1.0), new Enemy(Chara.all[127], 0.21), new Enemy(Chara.all[17], 0.0), new Enemy(Chara.all[11], 0.0), new Enemy(Chara.all[14], 0.0)]),
new Difficulty(108, "UDK姉妹乱入クエスト(RI姉貴戦)", true, [new Enemy(Chara.all[132], 1.0), new Enemy(Chara.all[128], 0.21), new Enemy(Chara.all[11], 0.0), new Enemy(Chara.all[12], 0.0), new Enemy(Chara.all[7], 0.0)]),
new Difficulty(109, "UDK姉妹乱入クエスト(朗読兄貴戦)", false, [new Enemy(Chara.all[133], 1.0), new Enemy(Chara.all[133], 0.0), new Enemy(Chara.all[133], 0.0), new Enemy(Chara.all[133], 0.0), new Enemy(Chara.all[1], 1.0)]),
new Difficulty(110, "立　教　大　学(EAS)", true, [new Enemy(Chara.all[15], 0.51), new Enemy(Chara.all[14], 0.0), new Enemy(Chara.all[12], 0.0), new Enemy(Chara.all[52], 0.31), new Enemy(Chara.all[4], 0.0), new Enemy(Chara.all[127], 0.31), new Enemy(Chara.all[137], 0.31), new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[17], 0.0), new Enemy(Chara.all[53], 0.31), new Enemy(Chara.all[11], 0.0), new Enemy(Chara.all[128], 0.31), new Enemy(Chara.all[138], 0.31), new Enemy(Chara.all[5], 0.0), new Enemy(Chara.all[7], 0.0), new Enemy(Chara.all[54], 0.31), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[126], 0.31), new Enemy(Chara.all[141], 0.06), new Enemy(Chara.all[14], 0.31), new Enemy(Chara.all[12], 0.31)]),
new Difficulty(111, "立　教　大　学(ADV)", true, [new Enemy(Chara.all[15], 0.11), new Enemy(Chara.all[14], 0.0), new Enemy(Chara.all[12], 0.0), new Enemy(Chara.all[16], 0.31), new Enemy(Chara.all[52], 1.0), new Enemy(Chara.all[44], 0.51), new Enemy(Chara.all[11], 0.0), new Enemy(Chara.all[43], 0.51), new Enemy(Chara.all[22], 0.51), new Enemy(Chara.all[137], 1.0), new Enemy(Chara.all[5], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[53], 1.0), new Enemy(Chara.all[128], 1.0), new Enemy(Chara.all[7], 0.0), new Enemy(Chara.all[11], 0.0), new Enemy(Chara.all[134], 0.31), new Enemy(Chara.all[18], 0.0), new Enemy(Chara.all[39], 0.0), new Enemy(Chara.all[127], 1.0), new Enemy(Chara.all[54], 1.0), new Enemy(Chara.all[26], 0.0), new Enemy(Chara.all[70], 1.0), new Enemy(Chara.all[67], 1.0), new Enemy(Chara.all[138], 1.0), new Enemy(Chara.all[35], 0.51), new Enemy(Chara.all[32], 0.0), new Enemy(Chara.all[33], 0.0), new Enemy(Chara.all[34], 0.0), new Enemy(Chara.all[126], 1.0), new Enemy(Chara.all[72], 0.0), new Enemy(Chara.all[28], 0.0), new Enemy(Chara.all[17], 1.0), new Enemy(Chara.all[102], 1.0), new Enemy(Chara.all[103], 1.0), new Enemy(Chara.all[101], 1.0), new Enemy(Chara.all[141], 0.21), new Enemy(Chara.all[139], 0.31), new Enemy(Chara.all[137], 0.31), new Enemy(Chara.all[138], 0.31), new Enemy(Chara.all[35], 0.31)]),
new Difficulty(112, "立　教　大　学(EXH)", true, [new Enemy(Chara.all[135], 0.31), new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[5], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[52], 0.0), new Enemy(Chara.all[44], 0.0), new Enemy(Chara.all[71], 0.0), new Enemy(Chara.all[43], 0.0), new Enemy(Chara.all[39], 0.0), new Enemy(Chara.all[137], 1.0), new Enemy(Chara.all[67], 0.0), new Enemy(Chara.all[95], 0.0), new Enemy(Chara.all[94], 0.0), new Enemy(Chara.all[127], 1.0), new Enemy(Chara.all[134], 1.0), new Enemy(Chara.all[85], 0.0), new Enemy(Chara.all[23], 0.0), new Enemy(Chara.all[11], 0.0), new Enemy(Chara.all[69], 0.0), new Enemy(Chara.all[53], 0.0), new Enemy(Chara.all[128], 1.0), new Enemy(Chara.all[7], 0.0), new Enemy(Chara.all[35], 0.0), new Enemy(Chara.all[107], 0.0), new Enemy(Chara.all[138], 1.0), new Enemy(Chara.all[35], 0.51), new Enemy(Chara.all[32], 0.0), new Enemy(Chara.all[33], 0.0), new Enemy(Chara.all[34], 0.0), new Enemy(Chara.all[136], 0.31), new Enemy(Chara.all[21], 0.0), new Enemy(Chara.all[20], 0.0), new Enemy(Chara.all[104], 0.0), new Enemy(Chara.all[54], 0.0), new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[19], 0.0), new Enemy(Chara.all[26], 0.0), new Enemy(Chara.all[14], 0.0), new Enemy(Chara.all[139], 0.0), new Enemy(Chara.all[70], 0.0), new Enemy(Chara.all[126], 0.0), new Enemy(Chara.all[93], 0.0), new Enemy(Chara.all[88], 0.0), new Enemy(Chara.all[105], 1.0), new Enemy(Chara.all[103], 0.0), new Enemy(Chara.all[101], 0.0), new Enemy(Chara.all[106], 1.0), new Enemy(Chara.all[11], 0.0), new Enemy(Chara.all[138], 0.0), new Enemy(Chara.all[141], 0.51), new Enemy(Chara.all[139], 0.51), new Enemy(Chara.all[137], 0.51), new Enemy(Chara.all[138], 0.51), new Enemy(Chara.all[140], 0.31)]),
new Difficulty(113, "立　教　大　学(LEG)", true, [new Enemy(Chara.all[135], 1.0), new Enemy(Chara.all[118], 0.0), new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[5], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[52], 0.0), new Enemy(Chara.all[44], 0.0), new Enemy(Chara.all[10], 0.0), new Enemy(Chara.all[43], 0.0), new Enemy(Chara.all[39], 0.0), new Enemy(Chara.all[137], 1.0), new Enemy(Chara.all[67], 0.0), new Enemy(Chara.all[95], 0.0), new Enemy(Chara.all[94], 0.0), new Enemy(Chara.all[127], 1.0), new Enemy(Chara.all[134], 1.0), new Enemy(Chara.all[85], 0.0), new Enemy(Chara.all[23], 0.0), new Enemy(Chara.all[11], 0.0), new Enemy(Chara.all[69], 0.0), new Enemy(Chara.all[53], 0.0), new Enemy(Chara.all[128], 1.0), new Enemy(Chara.all[7], 0.0), new Enemy(Chara.all[35], 0.0), new Enemy(Chara.all[107], 0.0), new Enemy(Chara.all[106], 1.0), new Enemy(Chara.all[38], 0.0), new Enemy(Chara.all[95], 0.0), new Enemy(Chara.all[41], 0.0), new Enemy(Chara.all[138], 1.0), new Enemy(Chara.all[35], 0.51), new Enemy(Chara.all[32], 0.0), new Enemy(Chara.all[33], 0.0), new Enemy(Chara.all[34], 0.0), new Enemy(Chara.all[136], 1.0), new Enemy(Chara.all[21], 0.0), new Enemy(Chara.all[20], 0.0), new Enemy(Chara.all[18], 0.0), new Enemy(Chara.all[54], 0.0), new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[19], 1.0), new Enemy(Chara.all[26], 0.0), new Enemy(Chara.all[14], 0.0), new Enemy(Chara.all[139], 0.0), new Enemy(Chara.all[70], 0.0), new Enemy(Chara.all[126], 0.0), new Enemy(Chara.all[93], 0.0), new Enemy(Chara.all[88], 0.0), new Enemy(Chara.all[140], 0.0), new Enemy(Chara.all[109], 0.0), new Enemy(Chara.all[105], 1.0), new Enemy(Chara.all[8], 0.0), new Enemy(Chara.all[141], 1.0), new Enemy(Chara.all[142], 0.31), new Enemy(Chara.all[137], 0.51), new Enemy(Chara.all[139], 0.51), new Enemy(Chara.all[140], 0.31), new Enemy(Chara.all[143], 1.0), new Enemy(Chara.all[141], 1.0), new Enemy(Chara.all[142], 1.0)]),
new Difficulty(114, "人間の里のゲーム屋(EAS)", false, [new Enemy(Chara.all[157], 1.0), new Enemy(Chara.all[104], 1.0), new Enemy(Chara.all[54], 1.0), new Enemy(Chara.all[102], 1.0), new Enemy(Chara.all[13], 1.0), new Enemy(Chara.all[52], 1.0), new Enemy(Chara.all[101], 1.0), new Enemy(Chara.all[128], 1.0), new Enemy(Chara.all[53], 1.0), new Enemy(Chara.all[103], 1.0), new Enemy(Chara.all[126], 1.0), new Enemy(Chara.all[127], 1.0), new Enemy(Chara.all[175], 0.31), new Enemy(Chara.all[10], 0.31), new Enemy(Chara.all[90], 0.31)]),
new Difficulty(115, "人間の里のゲーム屋(ADV)", false, [new Enemy(Chara.all[39], 1.0), new Enemy(Chara.all[21], 1.0), new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[20], 1.0), new Enemy(Chara.all[157], 1.0), new Enemy(Chara.all[104], 1.0), new Enemy(Chara.all[54], 1.0), new Enemy(Chara.all[42], 1.0), new Enemy(Chara.all[102], 1.0), new Enemy(Chara.all[13], 1.0), new Enemy(Chara.all[52], 1.0), new Enemy(Chara.all[88], 1.0), new Enemy(Chara.all[105], 1.0), new Enemy(Chara.all[8], 1.0), new Enemy(Chara.all[7], 1.0), new Enemy(Chara.all[127], 1.0), new Enemy(Chara.all[101], 1.0), new Enemy(Chara.all[128], 1.0), new Enemy(Chara.all[53], 1.0), new Enemy(Chara.all[95], 1.0), new Enemy(Chara.all[103], 1.0), new Enemy(Chara.all[126], 1.0), new Enemy(Chara.all[16], 1.0), new Enemy(Chara.all[147], 1.0), new Enemy(Chara.all[175], 0.51), new Enemy(Chara.all[40], 0.31), new Enemy(Chara.all[90], 0.31), new Enemy(Chara.all[35], 0.31), new Enemy(Chara.all[90], 0.31)]),
new Difficulty(116, "人間の里のゲーム屋(EXH)", false, [new Enemy(Chara.all[21], 1.0), new Enemy(Chara.all[39], 1.0), new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[20], 1.0), new Enemy(Chara.all[105], 1.0), new Enemy(Chara.all[8], 1.0), new Enemy(Chara.all[51], 1.0), new Enemy(Chara.all[127], 1.0), new Enemy(Chara.all[89], 1.0), new Enemy(Chara.all[88], 1.0), new Enemy(Chara.all[126], 1.0), new Enemy(Chara.all[52], 1.0), new Enemy(Chara.all[159], 1.0), new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[67], 1.0), new Enemy(Chara.all[19], 1.0), new Enemy(Chara.all[154], 1.0), new Enemy(Chara.all[54], 1.0), new Enemy(Chara.all[157], 1.0), new Enemy(Chara.all[128], 1.0), new Enemy(Chara.all[169], 1.0), new Enemy(Chara.all[22], 1.0), new Enemy(Chara.all[74], 1.0), new Enemy(Chara.all[75], 1.0), new Enemy(Chara.all[59], 1.0), new Enemy(Chara.all[147], 1.0), new Enemy(Chara.all[27], 1.0), new Enemy(Chara.all[7], 1.0), new Enemy(Chara.all[60], 1.0), new Enemy(Chara.all[35], 1.0), new Enemy(Chara.all[72], 1.0), new Enemy(Chara.all[41], 1.0), new Enemy(Chara.all[111], 1.0), new Enemy(Chara.all[44], 1.0), new Enemy(Chara.all[43], 1.0), new Enemy(Chara.all[11], 1.0), new Enemy(Chara.all[176], 1.0), new Enemy(Chara.all[175], 0.31), new Enemy(Chara.all[90], 0.31), new Enemy(Chara.all[40], 0.31)]),
new Difficulty(117, "まりスト例大祭(EAS)", false, [new Enemy(Chara.all[102], 1.0), new Enemy(Chara.all[101], 1.0), new Enemy(Chara.all[103], 1.0), new Enemy(Chara.all[62], 1.0), new Enemy(Chara.all[63], 1.0), new Enemy(Chara.all[64], 1.0), new Enemy(Chara.all[180], 0.31), new Enemy(Chara.all[52], 0.31), new Enemy(Chara.all[53], 0.31), new Enemy(Chara.all[54], 0.31)]),
new Difficulty(118, "まりスト例大祭(ADV)", false, [new Enemy(Chara.all[76], 1.0), new Enemy(Chara.all[77], 1.0), new Enemy(Chara.all[78], 1.0), new Enemy(Chara.all[57], 1.0), new Enemy(Chara.all[58], 1.0), new Enemy(Chara.all[59], 1.0), new Enemy(Chara.all[52], 1.0), new Enemy(Chara.all[53], 1.0), new Enemy(Chara.all[54], 1.0), new Enemy(Chara.all[126], 1.0), new Enemy(Chara.all[127], 1.0), new Enemy(Chara.all[128], 1.0), new Enemy(Chara.all[180], 0.51), new Enemy(Chara.all[79], 1.0), new Enemy(Chara.all[81], 1.0), new Enemy(Chara.all[80], 1.0)]),
new Difficulty(119, "まりスト例大祭(EXH)", false, [new Enemy(Chara.all[60], 1.0), new Enemy(Chara.all[88], 1.0), new Enemy(Chara.all[78], 1.0), new Enemy(Chara.all[76], 1.0), new Enemy(Chara.all[77], 1.0), new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[26], 1.0), new Enemy(Chara.all[27], 1.0), new Enemy(Chara.all[137], 1.0), new Enemy(Chara.all[140], 1.0), new Enemy(Chara.all[16], 1.0), new Enemy(Chara.all[15], 1.0), new Enemy(Chara.all[139], 1.0), new Enemy(Chara.all[138], 1.0), new Enemy(Chara.all[5], 1.0), new Enemy(Chara.all[6], 1.0), new Enemy(Chara.all[141], 1.0), new Enemy(Chara.all[142], 1.0), new Enemy(Chara.all[13], 1.0), new Enemy(Chara.all[106], 1.0), new Enemy(Chara.all[65], 1.0), new Enemy(Chara.all[62], 1.0), new Enemy(Chara.all[63], 1.0), new Enemy(Chara.all[64], 1.0), new Enemy(Chara.all[180], 1.0), new Enemy(Chara.all[18], 1.0), new Enemy(Chara.all[19], 1.0), new Enemy(Chara.all[79], 1.0)]),
new Difficulty(120, "まりスト例大祭(LEG)", false, [new Enemy(Chara.all[18], 0.0), new Enemy(Chara.all[19], 0.0), new Enemy(Chara.all[127], 0.0), new Enemy(Chara.all[76], 0.02), new Enemy(Chara.all[79], 0.0), new Enemy(Chara.all[141], 0.0), new Enemy(Chara.all[140], 0.0), new Enemy(Chara.all[77], 0.0), new Enemy(Chara.all[136], 0.0), new Enemy(Chara.all[31], 0.0), new Enemy(Chara.all[82], 0.0), new Enemy(Chara.all[35], 0.0), new Enemy(Chara.all[72], 0.0), new Enemy(Chara.all[65], 0.0), new Enemy(Chara.all[158], 0.0), new Enemy(Chara.all[7], 0.0), new Enemy(Chara.all[53], 0.0), new Enemy(Chara.all[59], 0.0), new Enemy(Chara.all[27], 0.0), new Enemy(Chara.all[7], 0.0), new Enemy(Chara.all[147], 0.0), new Enemy(Chara.all[143], 0.0), new Enemy(Chara.all[175], 0.0), new Enemy(Chara.all[142], 0.0), new Enemy(Chara.all[126], 0.0), new Enemy(Chara.all[153], 0.0), new Enemy(Chara.all[57], 0.0), new Enemy(Chara.all[58], 0.0), new Enemy(Chara.all[104], 0.0), new Enemy(Chara.all[81], 0.0), new Enemy(Chara.all[128], 0.0), new Enemy(Chara.all[51], 0.0), new Enemy(Chara.all[4], 0.0), new Enemy(Chara.all[137], 0.0), new Enemy(Chara.all[180], 1.0), new Enemy(Chara.all[17], 0.0), new Enemy(Chara.all[54], 0.0), new Enemy(Chara.all[95], 0.0), new Enemy(Chara.all[40], 0.0), new Enemy(Chara.all[181], 1.0), new Enemy(Chara.all[0], 0.0), new Enemy(Chara.all[1], 0.0), new Enemy(Chara.all[2], 0.0), new Enemy(Chara.all[9], 0.0)]),
new Difficulty(121, "三銃士乱入フェス(チャリオット平野戦)", false, [new Enemy(Chara.all[182], 1.0), new Enemy(Chara.all[68], 0.0), new Enemy(Chara.all[30], 0.0), new Enemy(Chara.all[127], 0.0), new Enemy(Chara.all[167], 0.0)]),
new Difficulty(122, "三銃士乱入フェス(剣聖おじさん戦)", false, [new Enemy(Chara.all[183], 1.0), new Enemy(Chara.all[104], 0.0), new Enemy(Chara.all[86], 0.0), new Enemy(Chara.all[57], 0.0), new Enemy(Chara.all[16], 0.0)]),
new Difficulty(123, "三銃士乱入フェス(破面KBTIT戦)", false, [new Enemy(Chara.all[184], 1.0), new Enemy(Chara.all[147], 0.0), new Enemy(Chara.all[7], 0.0), new Enemy(Chara.all[27], 0.0), new Enemy(Chara.all[158], 0.0)]),
new Difficulty(124, "三銃士乱入フェス(AKMRくん戦)", false, [new Enemy(Chara.all[185], 1.0), new Enemy(Chara.all[183], 1.0), new Enemy(Chara.all[184], 0.0), new Enemy(Chara.all[182], 0.0), new Enemy(Chara.all[23], 0.0)]),
new Difficulty(125, "釣リスマスおばさん乱入フェス(釣リスマスおばさん戦)", true, [new Enemy(Chara.all[204], 1.0), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[90], 1.0)]),
new Difficulty(126, "命蓮寺(EAS)", false, [new Enemy(Chara.all[52], 0.31), new Enemy(Chara.all[127], 0.51), new Enemy(Chara.all[142], 0.51), new Enemy(Chara.all[208], 0.31), new Enemy(Chara.all[196], 0.51), new Enemy(Chara.all[126], 0.51), new Enemy(Chara.all[79], 0.31), new Enemy(Chara.all[51], 0.51), new Enemy(Chara.all[128], 0.31), new Enemy(Chara.all[207], 0.31), new Enemy(Chara.all[204], 0.31), new Enemy(Chara.all[78], 0.31)]),
new Difficulty(127, "命蓮寺(ADV)", false, [new Enemy(Chara.all[207], 0.51), new Enemy(Chara.all[3], 0.51), new Enemy(Chara.all[57], 0.51), new Enemy(Chara.all[104], 0.51), new Enemy(Chara.all[78], 0.51), new Enemy(Chara.all[186], 0.31), new Enemy(Chara.all[9], 0.51), new Enemy(Chara.all[76], 0.51), new Enemy(Chara.all[159], 0.51), new Enemy(Chara.all[208], 0.51), new Enemy(Chara.all[28], 0.51), new Enemy(Chara.all[84], 0.51), new Enemy(Chara.all[5], 0.51), new Enemy(Chara.all[6], 0.51), new Enemy(Chara.all[79], 0.31), new Enemy(Chara.all[67], 0.51), new Enemy(Chara.all[53], 0.31), new Enemy(Chara.all[138], 0.31), new Enemy(Chara.all[42], 0.31), new Enemy(Chara.all[209], 0.31), new Enemy(Chara.all[54], 0.31), new Enemy(Chara.all[77], 0.31), new Enemy(Chara.all[27], 0.31), new Enemy(Chara.all[26], 0.31), new Enemy(Chara.all[102], 0.31), new Enemy(Chara.all[101], 0.31), new Enemy(Chara.all[171], 0.31), new Enemy(Chara.all[140], 0.31), new Enemy(Chara.all[142], 0.31), new Enemy(Chara.all[210], 0.31), new Enemy(Chara.all[103], 0.31), new Enemy(Chara.all[18], 0.31), new Enemy(Chara.all[19], 0.31)]),
new Difficulty(128, "命蓮寺(EXH)", false, [new Enemy(Chara.all[207], 0.31), new Enemy(Chara.all[28], 0.51), new Enemy(Chara.all[57], 0.51), new Enemy(Chara.all[104], 0.51), new Enemy(Chara.all[153], 0.51), new Enemy(Chara.all[186], 0.31), new Enemy(Chara.all[18], 0.51), new Enemy(Chara.all[76], 0.51), new Enemy(Chara.all[159], 0.51), new Enemy(Chara.all[208], 0.31), new Enemy(Chara.all[35], 0.51), new Enemy(Chara.all[32], 0.51), new Enemy(Chara.all[33], 0.51), new Enemy(Chara.all[34], 0.51), new Enemy(Chara.all[79], 0.31), new Enemy(Chara.all[67], 0.51), new Enemy(Chara.all[41], 0.31), new Enemy(Chara.all[157], 0.31), new Enemy(Chara.all[42], 0.31), new Enemy(Chara.all[209], 0.51), new Enemy(Chara.all[54], 0.31), new Enemy(Chara.all[77], 0.31), new Enemy(Chara.all[193], 0.31), new Enemy(Chara.all[67], 0.31), new Enemy(Chara.all[105], 0.31), new Enemy(Chara.all[8], 0.31), new Enemy(Chara.all[7], 0.31), new Enemy(Chara.all[81], 0.31), new Enemy(Chara.all[210], 0.51), new Enemy(Chara.all[140], 0.31), new Enemy(Chara.all[68], 0.31), new Enemy(Chara.all[167], 0.31), new Enemy(Chara.all[167], 0.31), new Enemy(Chara.all[109], 0.31), new Enemy(Chara.all[191], 0.51), new Enemy(Chara.all[180], 0.51), new Enemy(Chara.all[196], 0.51), new Enemy(Chara.all[211], 0.31), new Enemy(Chara.all[207], 0.31), new Enemy(Chara.all[208], 0.31), new Enemy(Chara.all[35], 0.31), new Enemy(Chara.all[41], 0.31)]),
new Difficulty(129, "命蓮寺(LEG)", false, [new Enemy(Chara.all[109], 0.31), new Enemy(Chara.all[191], 0.51), new Enemy(Chara.all[180], 0.51), new Enemy(Chara.all[17], 0.51), new Enemy(Chara.all[207], 1.0), new Enemy(Chara.all[67], 0.51), new Enemy(Chara.all[57], 0.51), new Enemy(Chara.all[28], 0.51), new Enemy(Chara.all[153], 0.51), new Enemy(Chara.all[44], 0.31), new Enemy(Chara.all[52], 0.51), new Enemy(Chara.all[39], 0.51), new Enemy(Chara.all[195], 0.51), new Enemy(Chara.all[67], 0.51), new Enemy(Chara.all[208], 1.0), new Enemy(Chara.all[35], 0.51), new Enemy(Chara.all[41], 0.51), new Enemy(Chara.all[78], 0.51), new Enemy(Chara.all[54], 0.51), new Enemy(Chara.all[206], 0.31), new Enemy(Chara.all[81], 0.51), new Enemy(Chara.all[205], 0.31), new Enemy(Chara.all[21], 0.31), new Enemy(Chara.all[209], 1.0), new Enemy(Chara.all[54], 0.31), new Enemy(Chara.all[77], 0.31), new Enemy(Chara.all[70], 0.31), new Enemy(Chara.all[67], 0.31), new Enemy(Chara.all[105], 0.31), new Enemy(Chara.all[8], 0.31), new Enemy(Chara.all[7], 0.31), new Enemy(Chara.all[81], 0.31), new Enemy(Chara.all[210], 1.0), new Enemy(Chara.all[140], 0.31), new Enemy(Chara.all[142], 0.31), new Enemy(Chara.all[93], 0.31), new Enemy(Chara.all[36], 0.31), new Enemy(Chara.all[107], 0.51), new Enemy(Chara.all[53], 0.31), new Enemy(Chara.all[94], 0.31), new Enemy(Chara.all[29], 0.31), new Enemy(Chara.all[69], 0.31), new Enemy(Chara.all[211], 1.0), new Enemy(Chara.all[207], 0.31), new Enemy(Chara.all[35], 0.31), new Enemy(Chara.all[36], 0.31), new Enemy(Chara.all[157], 0.31), new Enemy(Chara.all[88], 0.31), new Enemy(Chara.all[140], 0.31), new Enemy(Chara.all[88], 0.31), new Enemy(Chara.all[88], 0.31), new Enemy(Chara.all[88], 0.31), new Enemy(Chara.all[212], 1.0), new Enemy(Chara.all[207], 0.0), new Enemy(Chara.all[211], 0.0), new Enemy(Chara.all[209], 0.0), new Enemy(Chara.all[213], 1.0), new Enemy(Chara.all[212], 0.51), new Enemy(Chara.all[22], 0.0), new Enemy(Chara.all[79], 0.0)]),
new Difficulty(130, "セミ兄貴の森(EAS)", false, [new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[50], 0.31), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0)]),
new Difficulty(131, "セミ兄貴の森(ADV)", false, [new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[50], 0.61), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0)]),
new Difficulty(132, "セミ兄貴の森(EXH)", false, [new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[50], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0)]),
new Difficulty(133, "セミ兄貴の森(LEG)", false, [new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[50], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[109], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[48], 1.0), new Enemy(Chara.all[49], 1.0), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[90], 1.0), new Enemy(Chara.all[112], 1.0), new Enemy(Chara.all[50], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[109], 1.0)]),
new Difficulty(134, "妖精の森(EAS)", false, [new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[47], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[46], 0.0), new Enemy(Chara.all[118], 1.0), new Enemy(Chara.all[119], 1.0), new Enemy(Chara.all[121], 0.0), new Enemy(Chara.all[122], 0.0), new Enemy(Chara.all[120], 0.0)]),
new Difficulty(135, "妖精の森(ADV)", false, [new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[47], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[46], 0.0), new Enemy(Chara.all[5], 1.0), new Enemy(Chara.all[49], 0.0), new Enemy(Chara.all[118], 1.0), new Enemy(Chara.all[119], 0.51), new Enemy(Chara.all[121], 1.0), new Enemy(Chara.all[122], 1.0), new Enemy(Chara.all[120], 1.0)]),
new Difficulty(136, "妖精の森(EXH)", false, [new Enemy(Chara.all[118], 1.0), new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[7], 0.0), new Enemy(Chara.all[47], 0.0), new Enemy(Chara.all[119], 1.0), new Enemy(Chara.all[5], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[118], 0.0), new Enemy(Chara.all[46], 0.0), new Enemy(Chara.all[120], 1.0), new Enemy(Chara.all[121], 0.0), new Enemy(Chara.all[123], 1.0), new Enemy(Chara.all[118], 1.0), new Enemy(Chara.all[45], 0.0), new Enemy(Chara.all[122], 1.0), new Enemy(Chara.all[49], 0.0), new Enemy(Chara.all[5], 1.0), new Enemy(Chara.all[7], 1.0), new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[118], 1.0), new Enemy(Chara.all[120], 1.0), new Enemy(Chara.all[121], 1.0), new Enemy(Chara.all[124], 1.0), new Enemy(Chara.all[123], 1.0)]),
new Difficulty(137, "妖精の森(LEG)", false, [new Enemy(Chara.all[118], 1.0), new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[157], 0.0), new Enemy(Chara.all[7], 0.0), new Enemy(Chara.all[47], 0.0), new Enemy(Chara.all[119], 1.0), new Enemy(Chara.all[5], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[118], 0.0), new Enemy(Chara.all[46], 0.0), new Enemy(Chara.all[177], 1.0), new Enemy(Chara.all[5], 0.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[122], 0.0), new Enemy(Chara.all[46], 0.0), new Enemy(Chara.all[120], 1.0), new Enemy(Chara.all[121], 0.0), new Enemy(Chara.all[123], 1.0), new Enemy(Chara.all[118], 1.0), new Enemy(Chara.all[45], 0.0), new Enemy(Chara.all[122], 1.0), new Enemy(Chara.all[49], 0.0), new Enemy(Chara.all[5], 1.0), new Enemy(Chara.all[46], 1.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[178], 1.0), new Enemy(Chara.all[119], 0.0), new Enemy(Chara.all[118], 1.0), new Enemy(Chara.all[6], 0.0), new Enemy(Chara.all[179], 1.0), new Enemy(Chara.all[120], 1.0), new Enemy(Chara.all[118], 1.0), new Enemy(Chara.all[124], 1.0)]),
new Difficulty(138, "BBの森(EAS)", false, [new Enemy(Chara.all[198], 1.0), new Enemy(Chara.all[45], 1.0), new Enemy(Chara.all[199], 1.0), new Enemy(Chara.all[47], 1.0), new Enemy(Chara.all[200], 0.31), new Enemy(Chara.all[46], 0.0)]),
new Difficulty(139, "BBの森(ADV)", false, [new Enemy(Chara.all[157], 0.31), new Enemy(Chara.all[47], 0.0), new Enemy(Chara.all[3], 0.0), new Enemy(Chara.all[201], 0.31), new Enemy(Chara.all[49], 0.0), new Enemy(Chara.all[200], 1.0), new Enemy(Chara.all[199], 1.0), new Enemy(Chara.all[47], 0.0), new Enemy(Chara.all[104], 0.0), new Enemy(Chara.all[153], 0.0), new Enemy(Chara.all[28], 0.0), new Enemy(Chara.all[202], 0.31), new Enemy(Chara.all[48], 0.0), new Enemy(Chara.all[118], 0.0), new Enemy(Chara.all[120], 0.0), new Enemy(Chara.all[122], 0.0), new Enemy(Chara.all[203], 0.31), new Enemy(Chara.all[45], 0.0), new Enemy(Chara.all[4], 0.0), new Enemy(Chara.all[123], 0.0), new Enemy(Chara.all[198], 1.0)])
];
