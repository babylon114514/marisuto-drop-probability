...
new Difficulty(113, "三銃士乱入フェス(チャリオット平野戦)", false, [new Enemy(Chara.all[182], 1.0), new Enemy(Chara.all[68], 0.0), new Enemy(Chara.all[30], 0.0), new Enemy(Chara.all[127], 0.0), new Enemy(Chara.all[167], 0.0)]),
new Difficulty(114, "三銃士乱入フェス(剣聖おじさん戦)", false, [new Enemy(Chara.all[183], 1.0), new Enemy(Chara.all[104], 0.0), new Enemy(Chara.all[86], 0.0), new Enemy(Chara.all[57], 0.0), new Enemy(Chara.all[16], 0.0)]),
new Difficulty(115, "三銃士乱入フェス(破面KBTIT戦)", false, [new Enemy(Chara.all[184], 1.0), new Enemy(Chara.all[147], 0.0), new Enemy(Chara.all[7], 0.0), new Enemy(Chara.all[27], 0.0), new Enemy(Chara.all[158], 0.0)]),
new Difficulty(116, "三銃士乱入フェス(AKMRくん戦)", false, [new Enemy(Chara.all[185], 1.0), new Enemy(Chara.all[183], 1.0), new Enemy(Chara.all[184], 0.0), new Enemy(Chara.all[182], 0.0), new Enemy(Chara.all[23], 0.0)]),
